System.register("moment-tests", ["../moment"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var moment, day, dayWrapper, otherDay, day1, day2, day3, day4, day5, day6, now, day7, day8, day9, day10, array, day11, day12, a, b, a2, m, m2, duration, getMilliseconds, getSeconds, getMinutes, getHours, getDate, getDay, getMonth, getQuater, getYear, a3, a4, a5, b5, a6, b6, a7, b7, start, end, a8, b8, globalLang, localLang, adur, bdur;
    return {
        setters: [
            function (moment_1) {
                moment = moment_1;
        ...
        execute: function () {
            ...
            otherDay = moment(new Date(2020, 3, 7));
            day1 = moment(1318781876406);
            day2 = moment.unix(1318781876);
            day3 = moment("Dec 25, 1995");
            day4 = moment("12-25-1995", "MM-DD-YYYY");
            day5 = moment("12-25-1995", ["MM-DD-YYYY", "YYYY-MM-DD"]);
            day6 = moment("05-06-1995", ["MM-DD-YYYY", "DD-MM-YYYY"]);
            now = moment();
            day7 = moment([2010, 1, 14, 15, 25, 50, 125]);
            day8 = moment([2010]);
            day9 = moment([2010, 6]);
            day10 = moment([2010, 6, 10]);
            array = [2010, 1, 14, 15, 25, 50, 125];
            day11 = moment(Date.UTC.apply({}, array));
            day12 = moment.unix(1318781876);
            ...
            m = moment(new Date(2011, 2, 12, 5, 0, 0));
            m.hours();
            m.add('days', 1).hours();
            m2 = moment(new Date(2011, 2, 12, 5, 0, 0));
            m2.hours();
            ...
            getMilliseconds = moment().milliseconds();
            getSeconds = moment().seconds();
            getMinutes = moment().minutes();
            getHours = moment().hours();
            getDate = moment().date();
            getDay = moment().day();
            getMonth = moment().month();
            getQuater = moment().quarter();
            getYear = moment().year();
            moment().hours(0).minutes(0).seconds(0).milliseconds(0);
            a3 = moment([2011, 0, 1, 8]);
            a3.hours();
            a3.utc();
            a3.hours();
            a4 = moment([2010, 1, 14, 15, 25, 50, 125]);
            ...
            a6.from("1-28-2007");
            a7 = moment();
            b7 = moment("10-10-1900", "MM-DD-YYYY");
            a7.from(b7);
            start = moment([2007, 0, 5]);
            end = moment([2007, 0, 10]);
            start.from(end);
            start.from(end, true);
            ...
            adur = moment.duration(3, 'd');
            bdur = moment.duration(2, 'd');
...
System.register("test/helpers/each", [], function (exports_2, context_2) {
    "use strict";
    ...
    return {
        setters: [],
        execute: function () {
            exports_2("default", each);
        }
    };
});
System.register("test/helpers/object-keys", [], function (exports_3, context_3) {
    "use strict";
...
System.register("lib/utils/defaults", [], function (exports_4, context_4) {
    "use strict";
...
System.register("test/helpers/common-locale", ["test/qunit", "test/helpers/each", "test/helpers/object-keys", "../../moment"], function (exports_5, context_5) {
    "use strict";
    var __moduleName = context_5 && context_5.id;
    function defineCommonLocaleTests(locale, options) {
        qunit_1.test('lenient day of month ordinal parsing', function (assert) {
            var i, ordinalStr, testMoment;
            for (i = 1; i <= 31; ++i) {
                ordinalStr = moment_2["default"]([2014, 0, i]).format('YYYY MM Do');
                testMoment = moment_2["default"](ordinalStr, 'YYYY MM Do');
        ...
        qunit_1.test('lenient day of month ordinal parsing of number', function (assert) {
            var i, testMoment;
            for (i = 1; i <= 31; ++i) {
                testMoment = moment_2["default"]('2014 01 ' + i, 'YYYY MM Do');
        ...
        qunit_1.test('strict day of month ordinal parsing', function (assert) {
            var i, ordinalStr, testMoment;
            for (i = 1; i <= 31; ++i) {
                ordinalStr = moment_2["default"]([2014, 0, i]).format('YYYY MM Do');
                testMoment = moment_2["default"](ordinalStr, 'YYYY MM Do', true);
                assert.ok(testMoment.isValid(), 'strict day of month ordinal parsing ' + i);
            }
        });
        qunit_1.test('meridiem invariant', function (assert) {
            var h, m, t1, t2;
            for (h = 0; h < 24; ++h) {
                for (m = 0; m < 60; m += 15) {
                    t1 = moment_2["default"].utc([2000, 0, 1, h, m]);
                    t2 = moment_2["default"].utc(t1.format('A h:mm'), 'A h:mm');
                    assert.equal(t2.format('HH:mm'), t1.format('HH:mm'), 'meridiem at ' + t1.format('HH:mm'));
                }
            }
        });
        qunit_1.test('date format correctness', function (assert) {
            var data, tokens;
            data = moment_2["default"].localeData()._longDateFormat;
            tokens = object_keys_1["default"](data);
            each_1["default"](tokens, function (srchToken) {
                // Check each format string to make sure it does not contain any
                // tokens that need to be expanded.
                each_1["default"](tokens, function (baseToken) {
        ...
        qunit_1.test('month parsing correctness', function (assert) {
            var i, m;
            if (locale === 'tr') {
                // I can't fix it :(
                qunit_1.expect(0);
            ...
            function tester(format) {
                var r;
                r = moment_2["default"](m.format(format), format);
                assert.equal(r.month(), m.month(), 'month ' + i + ' fmt ' + format);
                r = moment_2["default"](m.format(format).toLocaleUpperCase(), format);
                assert.equal(r.month(), m.month(), 'month ' + i + ' fmt ' + format + ' upper');
                r = moment_2["default"](m.format(format).toLocaleLowerCase(), format);
                assert.equal(r.month(), m.month(), 'month ' + i + ' fmt ' + format + ' lower');
                r = moment_2["default"](m.format(format), format, true);
                assert.equal(r.month(), m.month(), 'month ' + i + ' fmt ' + format + ' strict');
                r = moment_2["default"](m.format(format).toLocaleUpperCase(), format, true);
                assert.equal(r.month(), m.month(), 'month ' + i + ' fmt ' + format + ' upper strict');
                r = moment_2["default"](m.format(format).toLocaleLowerCase(), format, true);
                assert.equal(r.month(), m.month(), 'month ' + i + ' fmt ' + format + ' lower strict');
            }
            for (i = 0; i < 12; ++i) {
                m = moment_2["default"]([2015, i, 15, 18]);
                tester('MMM');
                tester('MMM.');
                tester('MMMM');
                tester('MMMM.');
        ...
        qunit_1.test('weekday parsing correctness', function (assert) {
            var i, m;
            ...
            for (i = 0; i < 7; ++i) {
                m = moment_2["default"].utc([2015, 0, i + 1, 18]);
                tester('dd');
                tester('ddd');
                tester('dddd');
            }
        });
        qunit_1.test('valid localeData', function (assert) {
            assert.equal(moment_2["default"]().localeData().months().length, 12, 'months should return 12 months');
            assert.equal(moment_2["default"]().localeData().monthsShort().length, 12, 'monthsShort should return 12 months');
            assert.equal(moment_2["default"]().localeData().weekdays().length, 7, 'weekdays should return 7 days');
            assert.equal(moment_2["default"]().localeData().weekdaysShort().length, 7, 'weekdaysShort should return 7 days');
            assert.equal(moment_2["default"]().localeData().weekdaysMin().length, 7, 'monthsShort should return 7 days');
        });
    }
    exports_5("defineCommonLocaleTests", defineCommonLocaleTests);
    var qunit_1, each_1, object_keys_1, moment_2;
    return {
        setters: [
            function (qunit_1_1) {
                qunit_1 = qunit_1_1;
            ...
            function (object_keys_1_1) {
                object_keys_1 = object_keys_1_1;
            },
            function (moment_2_1) {
                moment_2 = moment_2_1;
            }
...
System.register("test/helpers/deprecation-handler", ["test/helpers/each"], function (exports_6, context_6) {
    "use strict";
    ...
    exports_6("setupDeprecationHandler", setupDeprecationHandler);
    function teardownDeprecationHandler(test, moment, scope) {
        moment.suppressDeprecationWarnings = test._oldSupress;
        if (test._expectedDeprecations != null) {
            var missedDeprecations = [];
            each_2["default"](test._expectedDeprecations, function (deprecationPattern, id) {
    ...
    exports_6("teardownDeprecationHandler", teardownDeprecationHandler);
...
/*global QUnit:false*/
System.register("test/qunit", ["../moment", "test/helpers/common-locale", "test/helpers/deprecation-handler"], function (exports_7, context_7) {
    "use strict";
    var __moduleName = context_7 && context_7.id;
    function module(name, lifecycle) {
        QUnit.module(name, {
            setup: function () {
                moment_3["default"].locale('en');
                moment_3["default"].createFromInputFallback = function (config) {
                    throw new Error('input not handled by moment: ' + config._i);
                };
                deprecation_handler_1.setupDeprecationHandler(test, moment_3["default"], 'core');
                if (lifecycle && lifecycle.setup) {
                    lifecycle.setup();
                }
            },
            teardown: function () {
                deprecation_handler_1.teardownDeprecationHandler(test, moment_3["default"], 'core');
    ...
    function localeModule(name, lifecycle) {
        QUnit.module('locale:' + name, {
            setup: function () {
                moment_3["default"].locale(name);
                moment_3["default"].createFromInputFallback = function (config) {
                    throw new Error('input not handled by moment: ' + config._i);
                };
                deprecation_handler_1.setupDeprecationHandler(test, moment_3["default"], 'locale');
                if (lifecycle && lifecycle.setup) {
                    lifecycle.setup();
                }
            },
            teardown: function () {
                moment_3["default"].locale('en');
                deprecation_handler_1.teardownDeprecationHandler(test, moment_3["default"], 'locale');
                if (lifecycle && lifecycle.teardown) {
                    lifecycle.teardown();
                }
            }
        });
        common_locale_1.defineCommonLocaleTests(name, -1, -1);
    }
    exports_7("localeModule", localeModule);
    var moment_3, common_locale_1, deprecation_handler_1, test, expect;
    return {
        setters: [
            function (moment_3_1) {
                moment_3 = moment_3_1;
            },
            function (common_locale_1_1) {
                common_locale_1 = common_locale_1_1;
            },
            function (deprecation_handler_1_1) {
                deprecation_handler_1 = deprecation_handler_1_1;
            }
        ],
        execute: function () {/*global QUnit:false*/
            exports_7("test", test = QUnit.test);
            exports_7("expect", expect = QUnit.expect);
        }
    };
});
System.register("test/moment/add_subtract", ["../../../moment", "test/qunit"], function (exports_8, context_8) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_2.module('add and subtract');
            qunit_2.test('add short reverse args', function (assert) {
                var a = moment(), b, c, d;
                a.year(2011);
                a.month(9);
                a.date(12);
            ...
            qunit_2.test('add long reverse args', function (assert) {
                var a = moment();
                a.year(2011);
                a.month(9);
                a.date(12);
            ...
            qunit_2.test('add long singular reverse args', function (assert) {
                var a = moment();
                a.year(2011);
                a.month(9);
                a.date(12);
            ...
            qunit_2.test('add string long reverse args', function (assert) {
                var a = moment(), b;
                qunit_2.test.expectedDeprecations('moment().add(period, number)');
                a.year(2011);
                a.month(9);
                a.date(12);
                a.hours(6);
            ...
            qunit_2.test('add string long singular reverse args', function (assert) {
                var a = moment(), b;
                qunit_2.test.expectedDeprecations('moment().add(period, number)');
                a.year(2011);
                a.month(9);
            ...
            qunit_2.test('add string short reverse args', function (assert) {
                var a = moment();
                qunit_2.test.expectedDeprecations('moment().add(period, number)');
                a.year(2011);
                a.month(9);
            ...
            qunit_2.test('add string long', function (assert) {
                var a = moment();
                a.year(2011);
                a.month(9);
                a.date(12);
            ...
            qunit_2.test('add string long singular', function (assert) {
                var a = moment();
                a.year(2011);
                a.month(9);
                a.date(12);
            ...
            qunit_2.test('add string short', function (assert) {
                var a = moment();
                a.year(2011);
                a.month(9);
                a.date(12);
            ...
            qunit_2.test('add strings string short reversed', function (assert) {
                var a = moment();
                qunit_2.test.expectedDeprecations('moment().add(period, number)');
                a.year(2011);
                a.month(9);
            ...
            qunit_2.test('subtract strings string short reversed', function (assert) {
                var a = moment();
                qunit_2.test.expectedDeprecations('moment().subtract(period, number)');
                a.year(2011);
                a.month(9);
                a.date(12);
                a.hours(6);
            ...
            qunit_2.test('add strings string short', function (assert) {
                var a = moment();
                a.year(2011);
                a.month(9);
                a.date(12);
            ...
            qunit_2.test('add no string with milliseconds default', function (assert) {
                var a = moment();
                a.year(2011);
                a.month(9);
                a.date(12);
            ...
            qunit_2.test('subtract strings string short', function (assert) {
                var a = moment();
                a.year(2011);
                a.month(9);
                a.date(12);
            ...
            qunit_2.test('add across DST', function (assert) {
                ...
                var a = moment(new Date(2011, 2, 12, 5, 0, 0)), b = moment(new Date(2011, 2, 12, 5, 0, 0)), c = moment(new Date(2011, 2, 12, 5, 0, 0)), d = moment(new Date(2011, 2, 12, 5, 0, 0)), e = moment(new Date(2011, 2, 12, 5, 0, 0));
                a.add(1, 'days');
                b.add(24, 'hours');
                c.add(1, 'months');
                e.add(1, 'quarter');
            ...
            qunit_2.test('add decimal values of days and months', function (assert) {
...
System.register("test/moment/calendar", ["../../../moment", "test/qunit"], function (exports_9, context_9) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_3.module('calendar');
            qunit_3.test('passing a function', function (assert) {
            ...
            qunit_3.test('extending calendar options', function (assert) {
...
System.register("test/moment/create", ["../../../moment", "test/qunit"], function (exports_10, context_10) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_4.module('create');
            qunit_4.test('array', function (assert) {
            ...
            qunit_4.test('object', function (assert) {
                var fmt = 'YYYY-MM-DD HH:mm:ss.SSS', tests = [
            ...
            qunit_4.test('multi format array copying', function (assert) {
            ...
            qunit_4.test('number', function (assert) {
            ...
            qunit_4.test('unix', function (assert) {
            ...
            qunit_4.test('date', function (assert) {
            ...
            qunit_4.test('date with a format as an array', function (assert) {
                var tests = [
                    new Date(2016, 9, 27),
                    new Date(2016, 9, 28),
                    new Date(2016, 9, 29),
            ...
            qunit_4.test('cloning moment should only copy own properties', function (assert) {
                assert.ok(!moment().clone().hasOwnProperty('month'), 'Should not clone prototype methods');
            });
            qunit_4.test('cloning moment works with weird clones', function (assert) {
            ...
            qunit_4.test('cloning respects moment.momentProperties', function (assert) {
                var m = moment();
            ...
            qunit_4.test('undefined', function (assert) {
                assert.ok(moment().toDate() instanceof Date, 'undefined');
            });
            qunit_4.test('iso with bad input', function (assert) {
            ...
            qunit_4.test('iso format 24hrs', function (assert) {
                assert.equal(moment('2014-01-01T24:00:00.000').format('YYYY-MM-DD[T]HH:mm:ss.SSS'), '2014-01-02T00:00:00.000', 'iso format with 24:00 localtime');
                assert.equal(moment.utc('2014-01-01T24:00:00.000').format('YYYY-MM-DD[T]HH:mm:ss.SSS'), '2014-01-02T00:00:00.000', 'iso format with 24:00 utc');
            });
            qunit_4.test('string without format - json', function (assert) {
            ...
            qunit_4.test('string with format dropped am/pm bug', function (assert) {
                moment.locale('en');
            ...
            qunit_4.test('empty string with formats', function (assert) {
            ...
            qunit_4.test('undefined argument with formats', function (assert) {
            ...
            qunit_4.test('defaulting to current date', function (assert) {
                var now = moment();
                assert.equal(moment('12:13:14', 'hh:mm:ss').format('YYYY-MM-DD hh:mm:ss'), now.clone().hour(12).minute(13).second(14).format('YYYY-MM-DD hh:mm:ss'), 'given only time default to current date');
                assert.equal(moment('05', 'DD').format('YYYY-MM-DD'), now.clone().date(5).format('YYYY-MM-DD'), 'given day of month default to current month, year');
                assert.equal(moment('05', 'MM').format('YYYY-MM-DD'), now.clone().month(4).date(1).format('YYYY-MM-DD'), 'given month default to current year');
                assert.equal(moment('1996', 'YYYY').format('YYYY-MM-DD'), now.clone().year(1996).month(0).date(1).format('YYYY-MM-DD'), 'given year do not default');
            });
            qunit_4.test('matching am/pm', function (assert) {
            ...
            qunit_4.test('string with format', function (assert) {
                moment.locale('en');
                var a = [
                    ['YYYY-Q', '2014-4'],
            ...
            qunit_4.test('2 digit year with YYYY format', function (assert) {
            ...
            qunit_4.test('unix timestamp format', function (assert) {
            ...
            qunit_4.test('unix offset milliseconds', function (assert) {
                assert.equal(moment('1234567890123', 'x').valueOf(), 1234567890123, 'x matches unix offset in milliseconds');
            });
            qunit_4.test('milliseconds format', function (assert) {
            ...
            qunit_4.test('string with format no separators', function (assert) {
                moment.locale('en');
                var a = [
                    ['MMDDYYYY', '12021999'],
                    ['DDMMYYYY', '12021999'],
            ...
            qunit_4.test('string with format (timezone)', function (assert) {
            ...
            qunit_4.test('string with format (timezone offset)', function (assert) {
                var a, b, c, d, e, f;
            ...
            qunit_4.test('string with timezone around start of year', function (assert) {
            ...
            qunit_4.test('string with array of formats', function (assert) {
            ...
            qunit_4.test('string with array of formats + ISO', function (assert) {
            ...
            qunit_4.test('string with format - years', function (assert) {
            ...
            qunit_4.test('implicit cloning', function (assert) {
                var momentA = moment([2011, 10, 10]), momentB = moment(momentA);
                momentA.month(5);
            ...
            qunit_4.test('explicit cloning', function (assert) {
                var momentA = moment([2011, 10, 10]), momentB = momentA.clone();
                momentA.month(5);
                assert.equal(momentB.month(), 10, 'Calling moment() on a moment will create a clone');
                assert.equal(momentA.month(), 5, 'Calling moment() on a moment will create a clone');
            });
            qunit_4.test('cloning carrying over utc mode', function (assert) {
            ...
            qunit_4.test('parsing RFC 2822', function (assert) {
                var testCases = {
            ...
            qunit_4.test('non RFC 2822 strings', function (assert) {
                var testCases = {
            ...
            qunit_4.test('parsing iso', function (assert) {
                var offset = moment([2011, 9, 8]).utcOffset(), pad = function (input) {
                    if (input < 10) {
                        return '0' + input;
                    }
                    return '' + input;
                }, hourOffset = (offset > 0 ? Math.floor(offset / 60) : Math.ceil(offset / 60)), minOffset = offset - (hourOffset * 60), tz = (offset >= 0) ?
                    '+' + pad(hourOffset) + ':' + pad(minOffset) :
                    '-' + pad(-hourOffset) + ':' + pad(-minOffset), tz2 = tz.replace(':', ''), tz3 = tz2.slice(0, 3), 
                //Tz3 removes minutes digit so will break the tests when parsed if they all use the same minutes digit
                minutesForTz3 = pad((4 + minOffset) % 60), minute = pad(4 + minOffset), formats = [
                ...
                for (i = 0; i < formats.length; i++) {
                    ...
                    assert.equal(moment(formats[i][0], moment.ISO_8601).format('YYYY-MM-DDTHH:mm:ss.SSSZ'), formats[i][1], 'moment should be able to parse specified ISO ' + formats[i][0]);
                    assert.equal(moment(formats[i][0], moment.ISO_8601, true).format('YYYY-MM-DDTHH:mm:ss.SSSZ'), formats[i][1], 'moment should be able to parse specified strict ISO ' + formats[i][0]);
                }
            });
            qunit_4.test('non iso 8601 strings', function (assert) {
            ...
            qunit_4.test('parsing iso week year/week/weekday', function (assert) {
            ...
            qunit_4.test('parsing week year/week/weekday (dow 1, doy 4)', function (assert) {
            ...
            qunit_4.test('parsing week year/week/weekday (dow 1, doy 7)', function (assert) {
            ...
            qunit_4.test('parsing week year/week/weekday (dow 0, doy 6)', function (assert) {
            ...
            qunit_4.test('parsing week year/week/weekday (dow 6, doy 12)', function (assert) {
            ...
            qunit_4.test('parsing ISO with Z', function (assert) {
                var i, mom, formats = [
            ...
            qunit_4.test('parsing iso with T', function (assert) {
            ...
            qunit_4.test('parsing iso Z timezone', function (assert) {
                var i, formats = [
            ...
            qunit_4.test('parsing iso Z timezone into local', function (assert) {
            ...
            qunit_4.test('parsing iso with more subsecond precision digits', function (assert) {
                assert.equal(moment.utc('2013-07-31T22:00:00.0000000Z').format(), '2013-07-31T22:00:00Z', 'more than 3 subsecond digits');
            });
            qunit_4.test('null or empty', function (assert) {
            ...
            qunit_4.test('first century', function (assert) {
            ...
            qunit_4.test('six digit years', function (assert) {
            ...
            qunit_4.test('negative four digit years', function (assert) {
            ...
            qunit_4.test('strict parsing', function (assert) {
            ...
            qunit_4.test('parsing into a locale', function (assert) {
            ...
            qunit_4.test('parsing week and weekday information', function (assert) {
            ...
            qunit_4.test('parsing localized weekdays', function (assert) {
                var ver = getVerifier(assert);
                try {
            ...
            qunit_4.test('parsing with customized two-digit year', function (assert) {
            ...
            qunit_4.test('milliseconds', function (assert) {
            ...
            qunit_4.test('hmm', function (assert) {
            ...
            qunit_4.test('Y token', function (assert) {
                assert.equal(moment('1-1-2010', 'M-D-Y', true).year(), 2010, 'parsing Y');
            });
            qunit_4.test('parsing flags retain parsed date parts', function (assert) {
            ...
            qunit_4.test('parsing only meridiem results in invalid date', function (assert) {
            ...
            qunit_4.test('invalid dates return invalid for methods that access the _d prop', function (assert) {
            ...
            qunit_4.test('k, kk', function (assert) {
                for (var i = -1; i <= 24; i++) {
                    var kVal = i + ':15:59';
...
System.register("test/moment/creation-data", ["../../../moment", "test/qunit"], function (exports_11, context_11) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_5.module('creation data');
            qunit_5.test('valid date', function (assert) {
...
System.register("test/moment/days_in_month", ["../../../moment", "test/qunit", "test/helpers/each"], function (exports_12, context_12) {
    "use strict";
    var __moduleName = context_12 && context_12.id;
    var moment, qunit_6, each_3;
    return {
        setters: [
            function (moment_8) {
                moment = moment_8;
        ...
        execute: function () {
            qunit_6.module('days in month');
            qunit_6.test('days in month', function (assert) {
                each_3["default"]([31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], function (days, i) {
                    var firstDay = moment([2012, i]), lastDay = moment([2012, i, days]);
            ...
            qunit_6.test('days in month leap years', function (assert) {
...
System.register("test/moment/days_in_year", ["../../../moment", "test/qunit"], function (exports_13, context_13) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_7.module('days in year');
            // https://github.com/moment/moment/issues/3717
            qunit_7.test('YYYYDDD should not parse DDD=000', function (assert) {
...
System.register("lib/utils/has-own-prop", [], function (exports_14, context_14) {
    "use strict";
    var __moduleName = context_14 && context_14.id;
    function hasOwnProp(a, b) {
        return Object.prototype.hasOwnProperty.call(a, b);
    }
    exports_14("default", hasOwnProp);
    return {
        setters: [],
        execute: function () {
        }
...
System.register("lib/utils/extend", ["lib/utils/has-own-prop"], function (exports_15, context_15) {
    "use strict";
    var __moduleName = context_15 && context_15.id;
    function extend(a, b) {
        for (var i in b) {
            if (has_own_prop_1["default"](b, i)) {
                a[i] = b[i];
            }
        }
        if (has_own_prop_1["default"](b, 'toString')) {
            a.toString = b.toString;
        }
        if (has_own_prop_1["default"](b, 'valueOf')) {
            a.valueOf = b.valueOf;
        }
        return a;
    }
    exports_15("default", extend);
    var has_own_prop_1;
    return {
        setters: [
            function (has_own_prop_1_1) {
                has_own_prop_1 = has_own_prop_1_1;
            }
        ],
        execute: function () {
        }
...
System.register("lib/utils/hooks", [], function (exports_16, context_16) {
    "use strict";
    var __moduleName = context_16 && context_16.id;
    function hooks() {
        return hookCallback.apply(null, arguments);
    }
    exports_16("hooks", hooks);
    // This is done to register the method called with moment()
    // without creating circular dependencies.
    function setHookCallback(callback) {
        hookCallback = callback;
    }
    exports_16("setHookCallback", setHookCallback);
    var hookCallback;
    return {
        setters: [],
        execute: function () {
...
System.register("lib/utils/is-undefined", [], function (exports_17, context_17) {
    "use strict";
    var __moduleName = context_17 && context_17.id;
    function isUndefined(input) {
        return input === void 0;
    }
    exports_17("default", isUndefined);
    return {
        setters: [],
        execute: function () {
        }
...
System.register("lib/utils/deprecate", ["lib/utils/extend", "lib/utils/hooks"], function (exports_18, context_18) {
    "use strict";
    ...
    exports_18("deprecate", deprecate);
    ...
    exports_18("deprecateSimple", deprecateSimple);
    var extend_1, hooks_1, deprecations;
    return {
        setters: [
            function (extend_1_1) {
                extend_1 = extend_1_1;
...
System.register("test/moment/deprecate", ["test/qunit", "lib/utils/deprecate"], function (exports_19, context_19) {
    "use strict";
    var __moduleName = context_19 && context_19.id;
    var qunit_8, deprecate_1;
    return {
        setters: [
            function (qunit_8_1) {
                qunit_8 = qunit_8_1;
            },
            function (deprecate_1_1) {
                deprecate_1 = deprecate_1_1;
            }
        ],
        execute: function () {
            qunit_8.module('deprecate');
            qunit_8.test('deprecate', function (assert) {
                // NOTE: hooks inside deprecate.js and moment are different, so this is can
                // not be test.expectedDeprecations(...)
                var fn = function () { };
                var deprecatedFn = deprecate_1.deprecate('testing deprecation', fn);
                deprecatedFn();
                qunit_8.expect(0);
            });
        }
...
System.register("test/moment/diff", ["../../../moment", "test/qunit"], function (exports_20, context_20) {
    "use strict";
    ...
    function dstForYear(year) {
        var start = moment([year]), end = moment([year + 1]), current = start.clone(), last;
        while (current < end) {
            last = current.clone();
            current.add(24, 'hour');
    ...
    return {
        ...
        execute: function () {
            qunit_9.module('diff');
            qunit_9.test('diff', function (assert) {
                ...
                var oneHourDate = new Date(2015, 5, 21), nowDate = new Date(+oneHourDate);
                oneHourDate.setHours(oneHourDate.getHours() + 1);
                assert.equal(moment(oneHourDate).diff(nowDate), 60 * 60 * 1000, '1 hour from now = 3600000');
            });
            qunit_9.test('diff key after', function (assert) {
            ...
            qunit_9.test('diff key before', function (assert) {
            ...
            qunit_9.test('diff key before singular', function (assert) {
            ...
            qunit_9.test('diff key before abbreviated', function (assert) {
            ...
            qunit_9.test('diff month', function (assert) {
                assert.equal(moment([2011, 0, 31]).diff([2011, 2, 1], 'months'), -1, 'month diff');
            });
            qunit_9.test('diff across DST', function (assert) {
            ...
            qunit_9.test('diff overflow', function (assert) {
            ...
            qunit_9.test('diff between utc and local', function (assert) {
            ...
            qunit_9.test('diff floored', function (assert) {
            ...
            qunit_9.test('exact month diffs', function (assert) {
                // generate all pairs of months and compute month diff, with fixed day
                // of month = 15.
                var m1, m2;
                for (m1 = 0; m1 < 12; ++m1) {
                    for (m2 = m1; m2 < 12; ++m2) {
                        assert.equal(moment([2013, m2, 15]).diff(moment([2013, m1, 15]), 'months', true), m2 - m1, 'month diff from 2013-' + m1 + '-15 to 2013-' + m2 + '-15');
                    }
                }
            });
            qunit_9.test('year diffs', function (assert) {
                // due to floating point math errors, these tests just need to be accurate within 0.00000001
            ...
            qunit_9.test('negative zero', function (assert) {
...
System.register("test/moment/duration", ["../../../moment", "test/qunit"], function (exports_21, context_21) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_10.module('duration');
            qunit_10.test('object instantiation', function (assert) {
            ...
            qunit_10.test('object instantiation with strings', function (assert) {
                var d = moment.duration({
                    years: '2',
                    months: '3',
                    weeks: '2',
            ...
            qunit_10.test('milliseconds instantiation', function (assert) {
            ...
            qunit_10.test('undefined instantiation', function (assert) {
            ...
            qunit_10.test('null instantiation', function (assert) {
            ...
            qunit_10.test('NaN instantiation', function (assert) {
            ...
            qunit_10.test('instantiation by type', function (assert) {
            ...
            qunit_10.test('shortcuts', function (assert) {
            ...
            qunit_10.test('generic getter', function (assert) {
            ...
            qunit_10.test('instantiation from another duration', function (assert) {
                var simple = moment.duration(1234), lengthy = moment.duration(60 * 60 * 24 * 360 * 1e3), complicated = moment.duration({
                    years: 2,
                    months: 3,
                    weeks: 4,
                    days: 1,
            ...
            qunit_10.test('instantiation from 24-hour time zero', function (assert) {
            ...
            qunit_10.test('instantiation from 24-hour time <24 hours', function (assert) {
            ...
            qunit_10.test('instatiation from serialized C# TimeSpan zero', function (assert) {
            ...
            qunit_10.test('instatiation from serialized C# TimeSpan with days', function (assert) {
            ...
            qunit_10.test('instatiation from serialized C# TimeSpan without days', function (assert) {
            ...
            qunit_10.test('instatiation from serialized C# TimeSpan without days or milliseconds', function (assert) {
            ...
            qunit_10.test('instatiation from serialized C# TimeSpan without milliseconds', function (assert) {
            ...
            qunit_10.test('instantiation from serialized C# TimeSpan with low millisecond precision', function (assert) {
            ...
            qunit_10.test('instantiation from serialized C# TimeSpan with high millisecond precision', function (assert) {
            ...
            qunit_10.test('instatiation from serialized C# TimeSpan maxValue', function (assert) {
            ...
            qunit_10.test('instatiation from serialized C# TimeSpan minValue', function (assert) {
            ...
            qunit_10.test('instantiation from ISO 8601 duration', function (assert) {
            ...
            qunit_10.test('serialization to ISO 8601 duration strings', function (assert) {
            ...
            qunit_10.test('toString acts as toISOString', function (assert) {
            ...
            qunit_10.test('toIsoString deprecation', function (assert) {
                qunit_10.test.expectedDeprecations('toIsoString()');
                assert.equal(moment.duration({}).toIsoString(), moment.duration({}).toISOString(), 'toIsoString delegates to toISOString');
            });
            qunit_10.test('`isodate` (python) test cases', function (assert) {
            ...
            qunit_10.test('ISO 8601 misuse cases', function (assert) {
            ...
            qunit_10.test('humanize', function (assert) {
                moment.locale('en');
            ...
            qunit_10.test('humanize duration with suffix', function (assert) {
                moment.locale('en');
            ...
            qunit_10.test('bubble value up', function (assert) {
            ...
            qunit_10.test('clipping', function (assert) {
            ...
            qunit_10.test('bubbling consistency', function (assert) {
                ...
                for (totalDays = 1; totalDays <= 500; ++totalDays) {
                    ...
                    assert.ok((months === newMonths && days + 1 === newDays) ||
                        (months + 1 === newMonths && newDays === 0), 'consistent total days ' + totalDays +
                        ' was ' + months + ' ' + days +
            ...
            qunit_10.test('effective equivalency', function (assert) {
            ...
            qunit_10.test('asGetters', function (assert) {
            ...
            qunit_10.test('as getters for small units', function (assert) {
                var dS = moment.duration(1, 'milliseconds'), ds = moment.duration(3, 'seconds'), dm = moment.duration(13, 'minutes');
            ...
            qunit_10.test('minutes getter for floating point hours', function (assert) {
            ...
            qunit_10.test('isDuration', function (assert) {
            ...
            qunit_10.test('add', function (assert) {
            ...
            qunit_10.test('add and bubble', function (assert) {
                var d;
            ...
            qunit_10.test('subtract and bubble', function (assert) {
                var d;
            ...
            qunit_10.test('subtract', function (assert) {
            ...
            qunit_10.test('JSON.stringify duration', function (assert) {
            ...
            qunit_10.test('duration plugins', function (assert) {
...
System.register("test/moment/duration_from_moments", ["../../../moment", "test/qunit"], function (exports_22, context_22) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_11.module('duration from moments');
            qunit_11.test('pure year diff', function (assert) {
                var m1 = moment('2012-01-01T00:00:00.000Z'), m2 = moment('2013-01-01T00:00:00.000Z');
            ...
            qunit_11.test('month and day diff', function (assert) {
                var m1 = moment('2012-01-15T00:00:00.000Z'), m2 = moment('2012-02-17T00:00:00.000Z'), d = moment.duration({ from: m1, to: m2 });
                assert.equal(d.get('days'), 2);
                assert.equal(d.get('months'), 1);
            });
            qunit_11.test('day diff, separate months', function (assert) {
                var m1 = moment('2012-01-15T00:00:00.000Z'), m2 = moment('2012-02-13T00:00:00.000Z'), d = moment.duration({ from: m1, to: m2 });
                assert.equal(d.as('days'), 29);
            });
            qunit_11.test('hour diff', function (assert) {
                var m1 = moment('2012-01-15T17:00:00.000Z'), m2 = moment('2012-01-16T03:00:00.000Z'), d = moment.duration({ from: m1, to: m2 });
                assert.equal(d.as('hours'), 10);
            });
            qunit_11.test('minute diff', function (assert) {
                var m1 = moment('2012-01-15T17:45:00.000Z'), m2 = moment('2012-01-16T03:15:00.000Z'), d = moment.duration({ from: m1, to: m2 });
                assert.equal(d.as('hours'), 9.5);
            });
        }
    };
});
System.register("test/moment/duration_invalid", ["../../../moment", "test/qunit"], function (exports_23, context_23) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_12.module('invalid');
            qunit_12.test('invalid duration', function (assert) {
                var m = moment.duration.invalid(); // should be invalid
                assert.equal(m.isValid(), false);
                assert.ok(isNaN(m.valueOf()));
            });
            qunit_12.test('valid duration', function (assert) {
                var m = moment.duration({ d: null }); // should be valid, for now
                assert.equal(m.isValid(), true);
                assert.equal(m.valueOf(), 0);
            });
            qunit_12.test('invalid duration - only smallest unit can have decimal', function (assert) {
            ...
            qunit_12.test('valid duration - smallest unit can have decimal', function (assert) {
                var m = moment.duration({ 'days': 3, 'hours': 1.1 }); // should be valid
                assert.equal(m.isValid(), true);
                assert.equal(m.asHours(), 73.1);
            });
            qunit_12.test('invalid duration with two arguments', function (assert) {
                var m = moment.duration(NaN, 'days');
                assert.equal(m.isValid(), false);
                assert.ok(isNaN(m.valueOf()));
            });
            qunit_12.test('invalid duration operations', function (assert) {
                var invalids = [
                    moment.duration(NaN),
                    moment.duration(NaN, 'days'),
                    moment.duration.invalid()
                ], i, invalid, valid = moment.duration();
                for (i = 0; i < invalids.length; ++i) {
                    ...
                    assert.equal(invalid.humanize(), invalid.localeData().invalidDate(), 'invalid.humanize is localized invalid duration string; i=' + i);
                    assert.equal(invalid.toISOString(), invalid.localeData().invalidDate(), 'invalid.toISOString is localized invalid duration string; i=' + i);
                    assert.equal(invalid.toString(), invalid.localeData().invalidDate(), 'invalid.toString is localized invalid duration string; i=' + i);
...
System.register("test/moment/format", ["../../../moment", "test/qunit"], function (exports_24, context_24) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_13.module('format');
            qunit_13.test('format YY', function (assert) {
                var b = moment(new Date(2009, 1, 14, 15, 25, 50, 125));
                assert.equal(b.format('YY'), '09', 'YY ---> 09');
            });
            qunit_13.test('format escape brackets', function (assert) {
                moment.locale('en');
                var b = moment(new Date(2009, 1, 14, 15, 25, 50, 125));
            ...
            qunit_13.test('handle negative years', function (assert) {
                moment.locale('en');
            ...
            qunit_13.test('format milliseconds', function (assert) {
            ...
            qunit_13.test('format timezone', function (assert) {
            ...
            qunit_13.test('format multiple with utc offset', function (assert) {
            ...
            qunit_13.test('isDST', function (assert) {
                var janOffset = new Date(2011, 0, 1).getTimezoneOffset(), julOffset = new Date(2011, 6, 1).getTimezoneOffset(), janIsDst = janOffset < julOffset, julIsDst = julOffset < janOffset, jan1 = moment([2011]), jul1 = moment([2011, 6]);
            ...
            qunit_13.test('unix timestamp', function (assert) {
            ...
            qunit_13.test('unix offset milliseconds', function (assert) {
            ...
            qunit_13.test('utcOffset sanity checks', function (assert) {
            ...
            qunit_13.test('default format', function (assert) {
            ...
            qunit_13.test('default UTC format', function (assert) {
            ...
            qunit_13.test('toJSON', function (assert) {
                var supportsJson = typeof JSON !== 'undefined' && JSON.stringify && JSON.stringify.call, date = moment('2012-10-09T21:30:40.678+0100');
            ...
            qunit_13.test('toISOString', function (assert) {
            ...
            qunit_13.test('inspect', function (assert) {
            ...
            qunit_13.test('long years', function (assert) {
            ...
            qunit_13.test('toISOString() when 0 year', function (assert) {
            ...
            qunit_13.test('iso week formats', function (assert) {
            ...
            qunit_13.test('iso week year formats', function (assert) {
                // https://en.wikipedia.org/wiki/ISO_week_date
                var cases = {
                    '2005-01-02': '2004-53',
                    '2005-12-31': '2005-52',
            ...
            qunit_13.test('week year formats', function (assert) {
                // https://en.wikipedia.org/wiki/ISO_week_date
                var cases = {
                    '2005-01-02': '2004-53',
                    '2005-12-31': '2005-52',
            ...
            qunit_13.test('iso weekday formats', function (assert) {
            ...
            qunit_13.test('weekday formats', function (assert) {
            ...
            qunit_13.test('toString is just human readable format', function (assert) {
                var b = moment(new Date(2009, 1, 5, 15, 25, 50, 125));
                assert.equal(b.toString(), b.format('ddd MMM DD YYYY HH:mm:ss [GMT]ZZ'));
            });
            qunit_13.test('toJSON skips postformat', function (assert) {
            ...
            qunit_13.test('calendar day timezone', function (assert) {
                moment.locale('en');
                var zones = [60, -60, 90, -90, 360, -360, 720, -720], b = moment().utc().startOf('day').subtract({ m: 1 }), c = moment().local().startOf('day').subtract({ m: 1 }), d = moment().local().startOf('day').subtract({ d: 2 }), i, z, a;
                for (i = 0; i < zones.length; ++i) {
                    z = zones[i];
                    a = moment().utcOffset(z).startOf('day').subtract({ m: 1 });
                    assert.equal(moment(a).utcOffset(z).calendar(), 'Yesterday at 11:59 PM', 'Yesterday at 11:59 PM, not Today, or the wrong time, tz = ' + z);
                }
            ...
            qunit_13.test('calendar with custom formats', function (assert) {
            ...
            qunit_13.test('quarter ordinal formats', function (assert) {
            ...
            //     });
            // });
            qunit_13.test('milliseconds', function (assert) {
            ...
            qunit_13.test('hmm and hmmss', function (assert) {
            ...
            qunit_13.test('k and kk', function (assert) {
            ...
            qunit_13.test('Y token', function (assert) {
...
System.register("test/moment/from_to", ["../../../moment", "test/qunit"], function (exports_25, context_25) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_14.module('from_to');
            qunit_14.test('from', function (assert) {
                var start = moment();
                moment.locale('en');
            ...
            qunit_14.test('from with absolute duration', function (assert) {
                var start = moment();
                moment.locale('en');
            ...
            qunit_14.test('to', function (assert) {
                var start = moment();
                moment.locale('en');
            ...
            qunit_14.test('to with absolute duration', function (assert) {
                var start = moment();
                moment.locale('en');
...
System.register("test/moment/getters_setters", ["../../../moment", "test/qunit"], function (exports_26, context_26) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_15.module('getters and setters');
            qunit_15.test('getters', function (assert) {
            ...
            qunit_15.test('getters programmatic', function (assert) {
                var a = moment([2011, 9, 12, 6, 7, 8, 9]);
            ...
            qunit_15.test('setters plural', function (assert) {
                var a = moment();
                qunit_15.test.expectedDeprecations('years accessor', 'months accessor', 'dates accessor');
                a.years(2011);
                a.months(9);
                a.dates(12);
                a.hours(6);
            ...
            qunit_15.test('setters singular', function (assert) {
                var a = moment();
                a.year(2011);
                a.month(9);
                a.date(12);
            ...
            qunit_15.test('setters', function (assert) {
                var a = moment();
                a.year(2011);
                a.month(9);
                a.date(12);
            ...
            qunit_15.test('setter programmatic', function (assert) {
                var a = moment();
                a.set('year', 2011);
                a.set('month', 9);
                a.set('date', 12);
            ...
            qunit_15.test('setters programatic with weeks', function (assert) {
                var a = moment();
                a.set('weekYear', 2001);
                a.set('week', 49);
                a.set('day', 4);
            ...
            qunit_15.test('setters programatic with weeks ISO', function (assert) {
                var a = moment();
            ...
            qunit_15.test('setters strings', function (assert) {
            ...
            qunit_15.test('setters - falsey values', function (assert) {
                var a = moment();
            ...
            qunit_15.test('chaining setters', function (assert) {
                var a = moment();
                a.year(2011)
                    .month(9)
                    .date(12)
            ...
            qunit_15.test('setter with multiple unit values', function (assert) {
                var a = moment();
                a.set({
                    year: 2011,
                    month: 9,
            ...
            qunit_15.test('day setter', function (assert) {
            ...
            qunit_15.test('object set ordering', function (assert) {
            ...
            qunit_15.test('string setters', function (assert) {
                var a = moment();
                a.year('2011');
                a.month('9');
                a.date('12');
            ...
            qunit_15.test('setters across DST +1', function (assert) {
                var oldUpdateOffset = moment.updateOffset, 
                // Based on a real story somewhere in America/Los_Angeles
                dstAt = moment('2014-03-09T02:00:00-08:00').parseZone(), m;
            ...
            qunit_15.test('setters across DST -1', function (assert) {
                var oldUpdateOffset = moment.updateOffset, 
                // Based on a real story somewhere in America/Los_Angeles
                dstAt = moment('2014-11-02T02:00:00-07:00').parseZone(), m;
                moment.updateOffset = function (mom, keepTime) {
                    if (mom.isBefore(dstAt)) {
                        mom.utcOffset(-7, keepTime);
                    }
...
System.register("test/moment/instanceof", ["../../../moment", "test/qunit"], function (exports_27, context_27) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_16.module('instanceof');
            qunit_16.test('instanceof', function (assert) {
...
System.register("test/moment/invalid", ["../../../moment", "test/qunit"], function (exports_28, context_28) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_17.module('invalid');
            qunit_17.test('invalid', function (assert) {
                var m = moment.invalid();
                assert.equal(m.isValid(), false);
                assert.equal(m.parsingFlags().userInvalidated, true);
                assert.ok(isNaN(m.valueOf()));
            });
            qunit_17.test('invalid with existing flag', function (assert) {
            ...
            qunit_17.test('invalid with custom flag', function (assert) {
            ...
            qunit_17.test('invalid operations', function (assert) {
                var invalids = [
                    moment.invalid(),
                    moment('xyz', 'l'),
                    moment('2015-01-35', 'YYYY-MM-DD'),
                    moment('2015-01-25 a', 'YYYY-MM-DD', true)
                ], i, invalid, valid = moment();
                qunit_17.test.expectedDeprecations('moment().min', 'moment().max', 'isDSTShifted');
                for (i = 0; i < invalids.length; ++i) {
                    invalid = invalids[i];
...
System.register("test/moment/is_after", ["../../../moment", "test/qunit"], function (exports_29, context_29) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_18.module('is after');
            qunit_18.test('is after without units', function (assert) {
            ...
            qunit_18.test('is after year', function (assert) {
            ...
            qunit_18.test('is after month', function (assert) {
            ...
            qunit_18.test('is after day', function (assert) {
            ...
            qunit_18.test('is after hour', function (assert) {
                var m = moment(new Date(2011, 3, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_18.test('is after minute', function (assert) {
                var m = moment(new Date(2011, 3, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_18.test('is after second', function (assert) {
                var m = moment(new Date(2011, 3, 2, 3, 4, 5, 10)), mCopy = moment(m);
            ...
            qunit_18.test('is after millisecond', function (assert) {
                var m = moment(new Date(2011, 3, 2, 3, 4, 5, 10)), mCopy = moment(m);
            ...
            qunit_18.test('is after invalid', function (assert) {
...
System.register("lib/utils/is-array", [], function (exports_30, context_30) {
    "use strict";
    var __moduleName = context_30 && context_30.id;
    function isArray(input) {
        return input instanceof Array || Object.prototype.toString.call(input) === '[object Array]';
    }
    exports_30("default", isArray);
    return {
        setters: [],
        execute: function () {
        }
...
System.register("test/moment/is_array", ["test/qunit", "lib/utils/is-array"], function (exports_31, context_31) {
    "use strict";
    var __moduleName = context_31 && context_31.id;
    var qunit_19, is_array_js_1;
    return {
        setters: [
            function (qunit_19_1) {
                qunit_19 = qunit_19_1;
            },
            function (is_array_js_1_1) {
                is_array_js_1 = is_array_js_1_1;
            }
        ],
        execute: function () {
            qunit_19.test('isArray recognizes Array objects', function (assert) {
                assert.ok(is_array_js_1["default"]([1, 2, 3]), 'array args');
                assert.ok(is_array_js_1["default"]([]), 'empty array');
                assert.ok(is_array_js_1["default"](new Array(1, 2, 3)), 'array constructor');
            });
            qunit_19.test('isArray rejects non-Array objects', function (assert) {
                assert.ok(!is_array_js_1["default"](), 'nothing');
                assert.ok(!is_array_js_1["default"](undefined), 'undefined');
                assert.ok(!is_array_js_1["default"](null), 'null');
                assert.ok(!is_array_js_1["default"](123), 'number');
                assert.ok(!is_array_js_1["default"]('[1,2,3]'), 'string');
                assert.ok(!is_array_js_1["default"](new Date()), 'date');
                assert.ok(!is_array_js_1["default"]({ a: 1, b: 2 }), 'object');
            });
        }
    };
});
System.register("test/moment/is_before", ["../../../moment", "test/qunit"], function (exports_32, context_32) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_20.module('is before');
            qunit_20.test('is after without units', function (assert) {
                var m = moment(new Date(2011, 3, 2, 3, 4, 5, 10)), mCopy = moment(m);
            ...
            qunit_20.test('is before year', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_20.test('is before month', function (assert) {
                var m = moment(new Date(2011, 2, 3, 4, 5, 6, 7)), mCopy = moment(m);
            ...
            qunit_20.test('is before day', function (assert) {
                var m = moment(new Date(2011, 3, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_20.test('is before hour', function (assert) {
                var m = moment(new Date(2011, 3, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_20.test('is before minute', function (assert) {
                var m = moment(new Date(2011, 3, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_20.test('is before second', function (assert) {
                var m = moment(new Date(2011, 3, 2, 3, 4, 5, 10)), mCopy = moment(m);
            ...
            qunit_20.test('is before millisecond', function (assert) {
                var m = moment(new Date(2011, 3, 2, 3, 4, 5, 10)), mCopy = moment(m);
            ...
            qunit_20.test('is before invalid', function (assert) {
                var m = moment(), invalid = moment.invalid();
...
System.register("test/moment/is_between", ["../../../moment", "test/qunit"], function (exports_33, context_33) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_21.module('is between');
            qunit_21.test('is between without units', function (assert) {
                var m = moment(new Date(2011, 3, 2, 3, 4, 5, 10)), mCopy = moment(m);
                assert.equal(m.isBetween(moment(new Date(2009, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10))), false, 'year is later');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2013, 3, 2, 3, 4, 5, 10))), false, 'year is earlier');
                assert.equal(m.isBetween(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), moment(new Date(2012, 3, 2, 3, 4, 5, 10))), true, 'year is between');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10))), false, 'month is later');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 5, 2, 3, 4, 5, 10))), false, 'month is earlier');
                assert.equal(m.isBetween(moment(new Date(2011, 2, 2, 3, 4, 5, 10)), moment(new Date(2011, 4, 2, 3, 4, 5, 10))), true, 'month is between');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 1, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10))), false, 'day is later');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 4, 3, 4, 5, 10))), false, 'day is earlier');
                ...
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 5, 4, 5, 10))), false, 'hour is earlier');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 2, 4, 5, 10)), moment(new Date(2011, 3, 2, 4, 4, 5, 10))), true, 'hour is between');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 6, 5, 10))), false, 'minute is later');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 2, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10))), false, 'minute is earlier');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 3, 5, 10)), moment(new Date(2011, 3, 2, 3, 5, 5, 10))), true, 'minute is between');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 7, 10))), false, 'second is later');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 3, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10))), false, 'second is earlier');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 4, 10)), moment(new Date(2011, 3, 2, 3, 4, 6, 10))), true, 'second is between');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 12))), false, 'millisecond is later');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 8)), moment(new Date(2011, 3, 2, 3, 4, 5, 10))), false, 'millisecond is earlier');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 9)), moment(new Date(2011, 3, 2, 3, 4, 5, 11))), true, 'millisecond is between');
            ...
            qunit_21.test('is between without units inclusivity', function (assert) {
                var m = moment(new Date(2011, 3, 2, 3, 4, 5, 10)), mCopy = moment(m);
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2012, 3, 2, 3, 4, 5, 10)), null, '()'), false, 'start and end are excluded, start is equal to moment');
                assert.equal(m.isBetween(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10)), null, '()'), false, 'start and end are excluded, end is equal to moment');
                assert.equal(m.isBetween(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), moment(new Date(2012, 3, 2, 3, 4, 5, 10)), null, '()'), true, 'start and end are excluded, is between');
                assert.equal(m.isBetween(moment(new Date(2009, 3, 2, 3, 4, 5, 10)), moment(new Date(2010, 3, 2, 3, 4, 5, 10)), null, '()'), false, 'start and end are excluded, is not between');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10)), null, '()'), false, 'start and end are excluded, should fail on same start/end date.');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2012, 3, 2, 3, 4, 5, 10)), null, '(]'), false, 'start is excluded and end is included should fail on same start date');
                assert.equal(m.isBetween(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10)), null, '(]'), true, 'start is excluded and end is included should succeed on end date');
                assert.equal(m.isBetween(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), moment(new Date(2012, 3, 2, 3, 4, 5, 10)), null, '(]'), true, 'start is excluded and end is included, is between');
                assert.equal(m.isBetween(moment(new Date(2009, 3, 2, 3, 4, 5, 10)), moment(new Date(2010, 3, 2, 3, 4, 5, 10)), null, '(]'), false, 'start is excluded and end is included, is not between');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10)), null, '(]'), false, 'start is excluded and end is included, should fail on same start/end date.');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2012, 3, 2, 3, 4, 5, 10)), null, '[)'), true, 'start is included and end is excluded should succeed on same start date');
                assert.equal(m.isBetween(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10)), null, '[)'), false, 'start is included and end is excluded should fail on same end date');
                assert.equal(m.isBetween(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), moment(new Date(2012, 3, 2, 3, 4, 5, 10)), null, '[)'), true, 'start is included and end is excluded, is between');
                assert.equal(m.isBetween(moment(new Date(2009, 3, 2, 3, 4, 5, 10)), moment(new Date(2010, 3, 2, 3, 4, 5, 10)), null, '[)'), false, 'start is included and end is excluded, is not between');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10)), null, '[)'), false, 'start is included and end is excluded, should fail on same end and start date');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2012, 3, 2, 3, 4, 5, 10)), null, '[]'), true, 'start and end inclusive should succeed on same start date');
                assert.equal(m.isBetween(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10)), null, '[]'), true, 'start and end inclusive should succeed on same end date');
                assert.equal(m.isBetween(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), moment(new Date(2012, 3, 2, 3, 4, 5, 10)), null, '[]'), true, 'start and end inclusive, is between');
                assert.equal(m.isBetween(moment(new Date(2009, 3, 2, 3, 4, 5, 10)), moment(new Date(2010, 3, 2, 3, 4, 5, 10)), null, '[]'), false, 'start and end inclusive, is not between');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10)), null, '[]'), true, 'start and end inclusive, should handle same end and start date');
            });
            qunit_21.test('is between milliseconds inclusivity', function (assert) {
                var m = moment(new Date(2011, 3, 2, 3, 4, 5, 10)), mCopy = moment(m);
                assert.equal(m.isBetween(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), moment(new Date(2012, 3, 2, 3, 4, 5, 10)), 'milliseconds'), true, 'options, no inclusive');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2012, 3, 2, 3, 4, 5, 10)), 'milliseconds', '()'), false, 'start and end are excluded, start is equal to moment');
                assert.equal(m.isBetween(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10)), 'milliseconds', '()'), false, 'start and end are excluded, end is equal to moment');
                assert.equal(m.isBetween(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), moment(new Date(2012, 3, 2, 3, 4, 5, 10)), 'milliseconds', '()'), true, 'start and end are excluded, is between');
                assert.equal(m.isBetween(moment(new Date(2009, 3, 2, 3, 4, 5, 10)), moment(new Date(2010, 3, 2, 3, 4, 5, 10)), 'milliseconds', '()'), false, 'start and end are excluded, is not between');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10)), 'milliseconds', '()'), false, 'start and end are excluded, should fail on same start/end date.');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2012, 3, 2, 3, 4, 5, 10)), 'milliseconds', '(]'), false, 'start is excluded and end is included should fail on same start date');
                assert.equal(m.isBetween(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10)), 'milliseconds', '(]'), true, 'start is excluded and end is included should succeed on end date');
                assert.equal(m.isBetween(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), moment(new Date(2012, 3, 2, 3, 4, 5, 10)), 'milliseconds', '(]'), true, 'start is excluded and end is included, is between');
                assert.equal(m.isBetween(moment(new Date(2009, 3, 2, 3, 4, 5, 10)), moment(new Date(2010, 3, 2, 3, 4, 5, 10)), 'milliseconds', '(]'), false, 'start is excluded and end is included, is not between');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10)), 'milliseconds', '(]'), false, 'start is excluded and end is included, should fail on same start/end date.');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2012, 3, 2, 3, 4, 5, 10)), 'milliseconds', '[)'), true, 'start is included and end is excluded should succeed on same start date');
                assert.equal(m.isBetween(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10)), 'milliseconds', '[)'), false, 'start is included and end is excluded should fail on same end date');
                assert.equal(m.isBetween(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), moment(new Date(2012, 3, 2, 3, 4, 5, 10)), 'milliseconds', '[)'), true, 'start is included and end is excluded, is between');
                assert.equal(m.isBetween(moment(new Date(2009, 3, 2, 3, 4, 5, 10)), moment(new Date(2010, 3, 2, 3, 4, 5, 10)), 'milliseconds', '[)'), false, 'start is included and end is excluded, is not between');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10)), 'milliseconds', '[)'), false, 'start is included and end is excluded, should fail on same end and start date');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2012, 3, 2, 3, 4, 5, 10)), 'milliseconds', '[]'), true, 'start and end inclusive should succeed on same start date');
                assert.equal(m.isBetween(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10)), 'milliseconds', '[]'), true, 'start and end inclusive should succeed on same end date');
                assert.equal(m.isBetween(moment(new Date(2010, 3, 2, 3, 4, 5, 10)), moment(new Date(2012, 3, 2, 3, 4, 5, 10)), 'milliseconds', '[]'), true, 'start and end inclusive, is between');
                assert.equal(m.isBetween(moment(new Date(2009, 3, 2, 3, 4, 5, 10)), moment(new Date(2010, 3, 2, 3, 4, 5, 10)), 'milliseconds', '[]'), false, 'start and end inclusive, is not between');
                assert.equal(m.isBetween(moment(new Date(2011, 3, 2, 3, 4, 5, 10)), moment(new Date(2011, 3, 2, 3, 4, 5, 10)), 'milliseconds', '[]'), true, 'start and end inclusive, should handle same end and start date');
            });
            qunit_21.test('is between year', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
                assert.equal(m.isBetween(moment(new Date(2011, 5, 6, 7, 8, 9, 10)), moment(new Date(2011, 5, 6, 7, 8, 9, 10)), 'year'), false, 'year match');
                assert.equal(m.isBetween(moment(new Date(2010, 5, 6, 7, 8, 9, 10)), moment(new Date(2012, 5, 6, 7, 8, 9, 10)), 'years'), true, 'plural should work');
                assert.equal(m.isBetween(moment(new Date(2010, 5, 6, 7, 8, 9, 10)), moment(new Date(2012, 5, 6, 7, 8, 9, 10)), 'year'), true, 'year is between');
                assert.equal(m.isBetween(moment(new Date(2011, 5, 6, 7, 8, 9, 10)), moment(new Date(2013, 5, 6, 7, 8, 9, 10)), 'year'), false, 'year is earlier');
                assert.equal(m.isBetween(moment(new Date(2010, 5, 6, 7, 8, 9, 10)), moment(new Date(2011, 5, 6, 7, 8, 9, 10)), 'year'), false, 'year is later');
            ...
            qunit_21.test('is between month', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
                assert.equal(m.isBetween(moment(new Date(2011, 1, 6, 7, 8, 9, 10)), moment(new Date(2011, 1, 6, 7, 8, 9, 10)), 'month'), false, 'month match');
                assert.equal(m.isBetween(moment(new Date(2011, 0, 6, 7, 8, 9, 10)), moment(new Date(2011, 2, 6, 7, 8, 9, 10)), 'months'), true, 'plural should work');
                assert.equal(m.isBetween(moment(new Date(2011, 0, 31, 23, 59, 59, 999)), moment(new Date(2011, 2, 1, 0, 0, 0, 0)), 'month'), true, 'month is between');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 6, 7, 8, 9, 10)), moment(new Date(2011, 2, 6, 7, 8, 9, 10)), 'month'), false, 'month is earlier');
                assert.equal(m.isBetween(moment(new Date(2011, 11, 6, 7, 8, 9, 10)), moment(new Date(2011, 1, 6, 7, 8, 9, 10)), 'month'), false, 'month is later');
            ...
            qunit_21.test('is between day', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 7, 8, 9, 10)), moment(new Date(2011, 1, 2, 7, 8, 9, 10)), 'day'), false, 'day match');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 1, 7, 8, 9, 10)), moment(new Date(2011, 1, 3, 7, 8, 9, 10)), 'days'), true, 'plural should work');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 1, 7, 8, 9, 10)), moment(new Date(2011, 1, 3, 7, 8, 9, 10)), 'day'), true, 'day is between');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 7, 8, 9, 10)), moment(new Date(2011, 1, 4, 7, 8, 9, 10)), 'day'), false, 'day is earlier');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 1, 7, 8, 9, 10)), moment(new Date(2011, 1, 2, 7, 8, 9, 10)), 'day'), false, 'day is later');
            ...
            qunit_21.test('is between hour', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 3, 5, 9, 10)), moment(new Date(2011, 1, 2, 3, 9, 9, 10)), 'hour'), false, 'hour match');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 1, 59, 59, 999)), moment(new Date(2011, 1, 2, 4, 0, 0, 0)), 'hours'), true, 'plural should work');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 2, 59, 59, 999)), moment(new Date(2011, 1, 2, 4, 0, 0, 0)), 'hour'), true, 'hour is between');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 7, 8, 9, 10)), moment(new Date(2011, 1, 2, 7, 8, 9, 10)), 'hour'), false, 'hour is earlier');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 7, 8, 9, 10)), moment(new Date(2011, 1, 2, 7, 8, 9, 10)), 'hour'), false, 'hour is later');
            ...
            qunit_21.test('is between minute', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 3, 4, 9, 10)), moment(new Date(2011, 1, 2, 3, 4, 9, 10)), 'minute'), false, 'minute match');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 3, 3, 9, 10)), moment(new Date(2011, 1, 2, 3, 5, 9, 10)), 'minutes'), true, 'plural should work');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 3, 3, 59, 999)), moment(new Date(2011, 1, 2, 3, 5, 0, 0)), 'minute'), true, 'minute is between');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 3, 5, 0, 0)), moment(new Date(2011, 1, 2, 3, 8, 9, 10)), 'minute'), false, 'minute is earlier');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 3, 2, 9, 10)), moment(new Date(2011, 1, 2, 3, 3, 59, 999)), 'minute'), false, 'minute is later');
            ...
            qunit_21.test('is between second', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 3, 4, 5, 10)), moment(new Date(2011, 1, 2, 3, 4, 5, 10)), 'second'), false, 'second match');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 3, 4, 4, 10)), moment(new Date(2011, 1, 2, 3, 4, 6, 10)), 'seconds'), true, 'plural should work');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 3, 4, 4, 999)), moment(new Date(2011, 1, 2, 3, 4, 6, 0)), 'second'), true, 'second is between');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 3, 4, 6, 0)), moment(new Date(2011, 1, 2, 3, 4, 7, 10)), 'second'), false, 'second is earlier');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 3, 4, 3, 10)), moment(new Date(2011, 1, 2, 3, 4, 4, 999)), 'second'), false, 'second is later');
                assert.equal(m.isBetween(m, 'second'), false, 'same moments are not between the same second');
                assert.equal(+m, +mCopy, 'isBetween second should not change moment');
            });
            qunit_21.test('is between millisecond', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 3, 4, 5, 6)), moment(new Date(2011, 1, 2, 3, 4, 5, 6)), 'millisecond'), false, 'millisecond match');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 3, 4, 5, 5)), moment(new Date(2011, 1, 2, 3, 4, 5, 7)), 'milliseconds'), true, 'plural should work');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 3, 4, 5, 5)), moment(new Date(2011, 1, 2, 3, 4, 5, 7)), 'millisecond'), true, 'millisecond is between');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 3, 4, 5, 7)), moment(new Date(2011, 1, 2, 3, 4, 5, 10)), 'millisecond'), false, 'millisecond is earlier');
                assert.equal(m.isBetween(moment(new Date(2011, 1, 2, 3, 4, 5, 4)), moment(new Date(2011, 1, 2, 3, 4, 5, 6)), 'millisecond'), false, 'millisecond is later');
...
System.register("test/moment/is_date", ["../../../moment", "test/qunit"], function (exports_34, context_34) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_22.module('is date');
            qunit_22.test('isDate recognizes Date objects', function (assert) {
            ...
            qunit_22.test('isDate rejects non-Date objects', function (assert) {
...
System.register("test/moment/is_moment", ["../../../moment", "test/qunit"], function (exports_35, context_35) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_23.module('is moment');
            qunit_23.test('is moment object', function (assert) {
                var MyObj = function () { }, extend = function (a, b) {
                    var i;
                    for (i in b) {
                        a[i] = b[i];
                    }
            ...
            qunit_23.test('is moment with hacked hasOwnProperty', function (assert) {
                var obj = {};
...
System.register("lib/utils/is-number", [], function (exports_36, context_36) {
    "use strict";
    var __moduleName = context_36 && context_36.id;
    function isNumber(input) {
        return typeof input === 'number' || Object.prototype.toString.call(input) === '[object Number]';
    }
    exports_36("default", isNumber);
    return {
        setters: [],
        execute: function () {
        }
...
System.register("test/moment/is_number", ["test/qunit", "lib/utils/is-number"], function (exports_37, context_37) {
    "use strict";
    var __moduleName = context_37 && context_37.id;
    var qunit_24, is_number_js_1;
    return {
        setters: [
            function (qunit_24_1) {
                qunit_24 = qunit_24_1;
            },
            function (is_number_js_1_1) {
                is_number_js_1 = is_number_js_1_1;
            }
        ],
        execute: function () {
            qunit_24.test('isNumber recognizes numbers', function (assert) {
                assert.ok(is_number_js_1["default"](1), 'simple integer');
                assert.ok(is_number_js_1["default"](0), 'simple number');
                assert.ok(is_number_js_1["default"](-0), 'silly number');
                assert.ok(is_number_js_1["default"](1010010293029), 'large number');
                assert.ok(is_number_js_1["default"](Infinity), 'largest number');
                assert.ok(is_number_js_1["default"](-Infinity), 'smallest number');
                assert.ok(is_number_js_1["default"](NaN), 'not number');
                assert.ok(is_number_js_1["default"](1.100393830000), 'decimal numbers');
                assert.ok(is_number_js_1["default"](Math.LN2), 'natural log of two');
                assert.ok(is_number_js_1["default"](Math.PI), 'delicious number');
                assert.ok(is_number_js_1["default"](5e10), 'scientifically notated number');
                assert.ok(is_number_js_1["default"](new Number(1)), 'number primitive wrapped in an object'); // jshint ignore:line
            });
            qunit_24.test('isNumber rejects non-numbers', function (assert) {
                assert.ok(!is_number_js_1["default"](), 'nothing');
                assert.ok(!is_number_js_1["default"](undefined), 'undefined');
                assert.ok(!is_number_js_1["default"](null), 'null');
                assert.ok(!is_number_js_1["default"]([1]), 'array');
                assert.ok(!is_number_js_1["default"]('[1,2,3]'), 'string');
                assert.ok(!is_number_js_1["default"](new Date()), 'date');
                assert.ok(!is_number_js_1["default"]({ a: 1, b: 2 }), 'object');
            });
        }
    };
});
System.register("test/moment/is_same", ["../../../moment", "test/qunit"], function (exports_38, context_38) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_25.module('is same');
            qunit_25.test('is same without units', function (assert) {
                var m = moment(new Date(2011, 3, 2, 3, 4, 5, 10)), mCopy = moment(m);
            ...
            qunit_25.test('is same year', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_25.test('is same month', function (assert) {
                var m = moment(new Date(2011, 2, 3, 4, 5, 6, 7)), mCopy = moment(m);
            ...
            qunit_25.test('is same day', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_25.test('is same hour', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_25.test('is same minute', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_25.test('is same second', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_25.test('is same millisecond', function (assert) {
                var m = moment(new Date(2011, 3, 2, 3, 4, 5, 10)), mCopy = moment(m);
            ...
            qunit_25.test('is same with utc offset moments', function (assert) {
                ...
                assert.ok(moment.parseZone('2013-02-01T00:00:00-05:00').isSame(moment.parseZone('2013-02-01T00:00:00-06:30'), 'year'), 'zoned vs (differently) zoned moment');
            });
            qunit_25.test('is same with invalid moments', function (assert) {
                assert.equal(moment.invalid().isSame(moment.invalid()), false, 'invalid moments are not considered equal');
            });
        }
    };
});
System.register("test/moment/is_same_or_after", ["../../../moment", "test/qunit"], function (exports_39, context_39) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_26.module('is same or after');
            qunit_26.test('is same or after without units', function (assert) {
                var m = moment(new Date(2011, 3, 2, 3, 4, 5, 10)), mCopy = moment(m);
            ...
            qunit_26.test('is same or after year', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_26.test('is same or after month', function (assert) {
                var m = moment(new Date(2011, 2, 3, 4, 5, 6, 7)), mCopy = moment(m);
            ...
            qunit_26.test('is same or after day', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_26.test('is same or after hour', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_26.test('is same or after minute', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_26.test('is same or after second', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_26.test('is same or after millisecond', function (assert) {
                var m = moment(new Date(2011, 3, 2, 3, 4, 5, 10)), mCopy = moment(m);
            ...
            qunit_26.test('is same or after with utc offset moments', function (assert) {
                ...
                assert.ok(moment.parseZone('2013-02-01T00:00:00-05:00').isSameOrAfter(moment.parseZone('2013-02-01T00:00:00-06:30'), 'year'), 'zoned vs (differently) zoned moment');
            });
            qunit_26.test('is same or after with invalid moments', function (assert) {
                var m = moment(), invalid = moment.invalid();
...
System.register("test/moment/is_same_or_before", ["../../../moment", "test/qunit"], function (exports_40, context_40) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_27.module('is same or before');
            qunit_27.test('is same or before without units', function (assert) {
                var m = moment(new Date(2011, 3, 2, 3, 4, 5, 10)), mCopy = moment(m);
            ...
            qunit_27.test('is same or before year', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_27.test('is same or before month', function (assert) {
                var m = moment(new Date(2011, 2, 3, 4, 5, 6, 7)), mCopy = moment(m);
            ...
            qunit_27.test('is same or before day', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_27.test('is same or before hour', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_27.test('is same or before minute', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_27.test('is same or before second', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)), mCopy = moment(m);
            ...
            qunit_27.test('is same or before millisecond', function (assert) {
                var m = moment(new Date(2011, 3, 2, 3, 4, 5, 10)), mCopy = moment(m);
            ...
            qunit_27.test('is same with utc offset moments', function (assert) {
                ...
                assert.ok(moment.parseZone('2013-02-01T00:00:00-05:00').isSameOrBefore(moment.parseZone('2013-02-01T00:00:00-06:30'), 'year'), 'zoned vs (differently) zoned moment');
            });
            qunit_27.test('is same with invalid moments', function (assert) {
                var m = moment(), invalid = moment.invalid();
...
System.register("test/moment/is_valid", ["../../../moment", "test/qunit"], function (exports_41, context_41) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            qunit_28.test('h/hh with hour > 12', function (assert) {
            ...
            qunit_28.test('array bad date leap year', function (assert) {
            ...
            qunit_28.test('string + formats bad date', function (assert) {
            ...
            qunit_28.test('string nonsensical with format', function (assert) {
            ...
            qunit_28.test('string with bad month name', function (assert) {
            ...
            qunit_28.test('string with spaceless format', function (assert) {
                assert.equal(moment('10Sep2001', 'DDMMMYYYY').isValid(), true, 'Parsing 10Sep2001 should result in a valid date');
            });
            qunit_28.test('invalid string iso 8601', function (assert) {
                var tests = [
                    '2010-00-00',
                    '2010-01-00',
                    '2010-01-40',
            ...
            qunit_28.test('invalid string iso 8601 + timezone', function (assert) {
                var tests = [
                    '2010-00-00T+00:00',
                    '2010-01-00T+00:00',
                    '2010-01-40T+00:00',
            ...
            qunit_28.test('valid string iso 8601 - not strict', function (assert) {
                var tests = [
            ...
            qunit_28.test('valid string iso 8601 + timezone', function (assert) {
                var tests = [
                    '2010-01-01',
                    '2010-01-30',
                    '2010-01-30T23+00:00',
            ...
            qunit_28.test('invalidAt', function (assert) {
            ...
            qunit_28.test('valid Unix timestamp', function (assert) {
            ...
            qunit_28.test('invalid Unix timestamp', function (assert) {
            ...
            qunit_28.test('valid Unix offset milliseconds', function (assert) {
            ...
            qunit_28.test('invalid Unix offset milliseconds', function (assert) {
                assert.equal(moment(undefined, 'x').isValid(), false, 'undefined');
                assert.equal(moment('undefined', 'x').isValid(), false, 'string undefined');
                try {
                    assert.equal(moment(null, 'x').isValid(), false, 'null');
            ...
            qunit_28.test('empty', function (assert) {
            ...
            qunit_28.test('days of the year', function (assert) {
            ...
            qunit_28.test('24:00:00.000 is valid', function (assert) {
            ...
            qunit_28.test('oddball permissiveness', function (assert) {
            ...
            qunit_28.test('0 hour is invalid in strict', function (assert) {
...
System.register("test/moment/leapyear", ["../../../moment", "test/qunit"], function (exports_42, context_42) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_29.module('leap year');
            qunit_29.test('leap year', function (assert) {
...
System.register("test/moment/listers", ["../../../moment", "test/qunit"], function (exports_43, context_43) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_30.module('listers');
            qunit_30.test('default', function (assert) {
            ...
            qunit_30.test('index', function (assert) {
            ...
            qunit_30.test('with functions', function (assert) {
                var monthsShort = 'one_two_three_four_five_six_seven_eight_nine_ten_eleven_twelve'.split('_'), monthsShortWeird = 'onesy_twosy_threesy_foursy_fivesy_sixsy_sevensy_eightsy_ninesy_tensy_elevensy_twelvesy'.split('_');
            ...
            qunit_30.test('with locale data', function (assert) {
                var months = 'one_two_three_four_five_six_seven_eight_nine_ten_eleven_twelve'.split('_'), monthsShort = 'on_tw_th_fo_fi_si_se_ei_ni_te_el_tw'.split('_'), weekdays = 'one_two_three_four_five_six_seven'.split('_'), weekdaysShort = 'on_tw_th_fo_fi_si_se'.split('_'), weekdaysMin = '1_2_3_4_5_6_7'.split('_'), weekdaysLocale = 'four_five_six_seven_one_two_three'.split('_'), weekdaysShortLocale = 'fo_fi_si_se_on_tw_th'.split('_'), weekdaysMinLocale = '4_5_6_7_1_2_3'.split('_'), week = {
                    dow: 3,
                    doy: 6
                };
...
System.register("lib/utils/index-of", [], function (exports_44, context_44) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            if (Array.prototype.indexOf) {
                exports_44("default", indexOf = Array.prototype.indexOf);
            }
            else {
                exports_44("default", indexOf = function (o) {
                    // I know
                    var i;
...
System.register("test/moment/locale", ["../../../moment", "test/qunit", "test/helpers/each", "lib/utils/index-of"], function (exports_45, context_45) {
    "use strict";
    var __moduleName = context_45 && context_45.id;
    var moment, qunit_31, each_4, index_of_1;
    return {
        setters: [
            function (moment_30) {
                moment = moment_30;
            ...
            function (index_of_1_1) {
                index_of_1 = index_of_1_1;
            }
        ],
        execute: function () {
            qunit_31.module('locale', {
                setup: function () {
            ...
            qunit_31.test('library getters and setters', function (assert) {
            ...
            qunit_31.test('library setter array of locales', function (assert) {
            ...
            qunit_31.test('library setter locale substrings', function (assert) {
            ...
            qunit_31.test('library getter locale array and substrings', function (assert) {
            ...
            qunit_31.test('library ensure inheritance', function (assert) {
            ...
            qunit_31.test('library ensure inheritance LT L LL LLL LLLL', function (assert) {
            ...
            qunit_31.test('library localeData', function (assert) {
                moment.locale('en');
            ...
            qunit_31.test('library deprecations', function (assert) {
                qunit_31.test.expectedDeprecations('moment.lang');
            ...
            qunit_31.test('defineLocale', function (assert) {
                moment.locale('en');
            ...
            qunit_31.test('locales', function (assert) {
                moment.defineLocale('dude', { months: ['Movember'] });
                assert.equal(true, !!~index_of_1["default"].call(moment.locales(), 'dude'), 'locales returns an array of defined locales');
                assert.equal(true, !!~index_of_1["default"].call(moment.locales(), 'en'), 'locales should always include english');
                moment.defineLocale('dude', null);
            });
            qunit_31.test('library convenience', function (assert) {
            ...
            qunit_31.test('firstDayOfWeek firstDayOfYear locale getters', function (assert) {
            ...
            qunit_31.test('instance locale method', function (assert) {
                moment.locale('en');
            ...
            qunit_31.test('instance locale method with array', function (assert) {
            ...
            qunit_31.test('instance getter locale substrings', function (assert) {
                var m = moment();
                m.locale('fr-crap');
            ...
            qunit_31.test('instance locale persists with manipulation', function (assert) {
                moment.locale('en');
            ...
            qunit_31.test('instance locale persists with cloning', function (assert) {
                moment.locale('en');
                var a = moment([2012, 5, 6]).locale('es'), b = a.clone(), c = moment(a);
                assert.equal(b.format('MMMM'), 'junio', 'using moment.fn.clone()');
                assert.equal(b.format('MMMM'), 'junio', 'using moment()');
            });
            qunit_31.test('duration locale method', function (assert) {
                moment.locale('en');
            ...
            qunit_31.test('duration locale persists with cloning', function (assert) {
                moment.locale('en');
                var a = moment.duration({ seconds: 44 }).locale('es'), b = moment.duration(a);
                assert.equal(b.humanize(), 'unos segundos', 'using moment.duration()');
            });
            qunit_31.test('changing the global locale doesn\'t affect existing duration instances', function (assert) {
                var mom = moment.duration();
                moment.locale('fr');
                assert.equal('en', mom.locale());
            });
            qunit_31.test('duration deprecations', function (assert) {
                qunit_31.test.expectedDeprecations('moment().lang()');
                assert.equal(moment.duration().lang(), moment.duration().localeData(), 'duration.lang is the same as duration.localeData');
            });
            qunit_31.test('from and fromNow with invalid date', function (assert) {
            ...
            qunit_31.test('from relative time future', function (assert) {
            ...
            qunit_31.test('from relative time past', function (assert) {
                var start = moment([2007, 1, 28]);
            ...
            qunit_31.test('instance locale used with from', function (assert) {
                moment.locale('en');
                var a = moment([2012, 5, 6]).locale('es'), b = moment([2012, 5, 7]);
            ...
            qunit_31.test('instance localeData', function (assert) {
                moment.defineLocale('dude', { week: { dow: 3 } });
                assert.equal(moment().locale('dude').localeData()._week.dow, 3);
                moment.defineLocale('dude', null);
            });
            qunit_31.test('month name callback function', function (assert) {
            ...
            qunit_31.test('changing parts of a locale config', function (assert) {
                qunit_31.test.expectedDeprecations('defineLocaleOverride');
            ...
            qunit_31.test('start/endOf week feature for first-day-is-monday locales', function (assert) {
            ...
            qunit_31.test('meridiem parsing', function (assert) {
            ...
            qunit_31.test('invalid date formatting', function (assert) {
            ...
            qunit_31.test('return locale name', function (assert) {
            ...
            qunit_31.test('changing the global locale doesn\'t affect existing instances', function (assert) {
                var mom = moment();
                moment.locale('fr');
                assert.equal('en', mom.locale());
            });
            qunit_31.test('setting a language on instance returns the original moment for chaining', function (assert) {
                qunit_31.test.expectedDeprecations('moment().lang()');
                var mom = moment();
            ...
            qunit_31.test('lang(key) changes the language of the instance', function (assert) {
                qunit_31.test.expectedDeprecations('moment().lang()');
                var m = moment().month(0);
                m.lang('fr');
                assert.equal(m.locale(), 'fr', 'm.lang(key) changes instance locale');
            });
            qunit_31.test('moment#locale(false) resets to global locale', function (assert) {
                var m = moment();
                moment.locale('fr');
                m.locale('it');
            ...
            qunit_31.test('moment().locale with missing key doesn\'t change locale', function (assert) {
                assert.equal(moment().locale('boo').localeData(), moment.localeData(), 'preserve global locale in case of bad locale id');
            });
            qunit_31.test('moment().lang with missing key doesn\'t change locale', function (assert) {
                qunit_31.test.expectedDeprecations('moment().lang()');
                assert.equal(moment().lang('boo').localeData(), moment.localeData(), 'preserve global locale in case of bad locale id');
            });
...
System.register("test/moment/locale_inheritance", ["../../../moment", "test/qunit"], function (exports_46, context_46) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_32.module('locale inheritance');
            qunit_32.test('calendar', function (assert) {
            ...
            qunit_32.test('missing', function (assert) {
            ...
            qunit_32.test('long date format', function (assert) {
            ...
            qunit_32.test('ordinal', function (assert) {
            ...
            qunit_32.test('ordinal parse', function (assert) {
            ...
            qunit_32.test('months', function (assert) {
            ...
            qunit_32.test('define child locale before parent', function (assert) {
...
System.register("test/moment/locale_update", ["../../../moment", "test/qunit"], function (exports_47, context_47) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_33.module('locale update');
            qunit_33.test('calendar', function (assert) {
            ...
            qunit_33.test('missing', function (assert) {
            ...
            // Test function vs obj both directions
            qunit_33.test('long date format', function (assert) {
            ...
            qunit_33.test('ordinal', function (assert) {
            ...
            qunit_33.test('ordinal parse', function (assert) {
            ...
            qunit_33.test('months', function (assert) {
...
System.register("test/moment/min_max", ["../../../moment", "test/qunit"], function (exports_48, context_48) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_34.module('min max');
            qunit_34.test('min', function (assert) {
                var now = moment(), future = now.clone().add(1, 'month'), past = now.clone().subtract(1, 'month'), invalid = moment.invalid();
            ...
            qunit_34.test('max', function (assert) {
                var now = moment(), future = now.clone().add(1, 'month'), past = now.clone().subtract(1, 'month'), invalid = moment.invalid();
...
System.register("test/moment/mutable", ["../../../moment", "test/qunit"], function (exports_49, context_49) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_35.module('mutable');
            qunit_35.test('manipulation methods', function (assert) {
                var m = moment();
            ...
            qunit_35.test('non mutable methods', function (assert) {
                var m = moment();
...
System.register("test/moment/normalize_units", ["../../../moment", "test/qunit"], function (exports_50, context_50) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_36.module('normalize units');
            qunit_36.test('normalize units', function (assert) {
                var fullKeys = ['year', 'quarter', 'month', 'isoWeek', 'week', 'day', 'hour', 'minute', 'second', 'millisecond', 'date', 'dayOfYear', 'weekday', 'isoWeekday', 'weekYear', 'isoWeekYear'], aliases = ['y', 'Q', 'M', 'W', 'w', 'd', 'h', 'm', 's', 'ms', 'D', 'DDD', 'e', 'E', 'gg', 'GG'], length = fullKeys.length, fullKey, fullKeyCaps, fullKeyPlural, fullKeyCapsPlural, fullKeyLower, alias, index;
...
System.register("test/moment/now", ["../../../moment", "test/qunit"], function (exports_51, context_51) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_37.module('now');
            qunit_37.test('now', function (assert) {
                var startOfTest = new Date().valueOf(), momentNowTime = moment.now(), afterMomentCreationTime = new Date().valueOf();
            ...
            qunit_37.test('now - Date mocked', function (assert) {
                // We need to test mocking the global Date object, so disable 'Read Only' jshint check
                /* jshint -W020 */
                var RealDate = Date, customTimeMs = moment('2015-01-01T01:30:00.000Z').valueOf();
                function MockDate() {
            ...
            qunit_37.test('now - custom value', function (assert) {
                var customTimeStr = '2015-01-01T01:30:00.000Z', customTime = moment(customTimeStr, moment.ISO_8601).valueOf(), oldFn = moment.now;
                moment.now = function () {
                    return customTime;
                };
                try {
            ...
            qunit_37.test('empty object, empty array', function (assert) {
                function assertIsNow(gen, msg) {
                    var before = +(new Date()), mid = gen(), after = +(new Date());
...
System.register("test/moment/parsing_flags", ["../../../moment", "test/qunit"], function (exports_52, context_52) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_38.module('parsing flags');
            qunit_38.test('overflow with array', function (assert) {
                //months
            ...
            qunit_38.test('overflow without format', function (assert) {
                //months
            ...
            qunit_38.test('extra tokens', function (assert) {
            ...
            qunit_38.test('extra tokens strict', function (assert) {
            ...
            qunit_38.test('unused input', function (assert) {
            ...
            qunit_38.test('unused input strict', function (assert) {
            ...
            qunit_38.test('chars left over', function (assert) {
            ...
            qunit_38.test('empty', function (assert) {
            ...
            qunit_38.test('null', function (assert) {
            ...
            qunit_38.test('invalid month', function (assert) {
            ...
            qunit_38.test('empty format array', function (assert) {
...
System.register("test/moment/preparse_postformat", ["../../../moment", "test/qunit"], function (exports_53, context_53) {
    "use strict";
    var __moduleName = context_53 && context_53.id;
    var moment, qunit_39, symbolMap, numberMap;
    return {
        setters: [
            function (moment_38) {
                moment = moment_38;
        ...
        execute: function () {
            ...
            qunit_39.module('preparse and postformat', {
                setup: function () {
            ...
            qunit_39.test('transform', function (assert) {
            ...
            qunit_39.test('transform from', function (assert) {
                var start = moment([2007, 1, 28]);
            ...
            qunit_39.test('calendar day', function (assert) {
...
System.register("test/moment/quarter", ["../../../moment", "test/qunit"], function (exports_54, context_54) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_40.module('quarter');
            qunit_40.test('library quarter getter', function (assert) {
            ...
            qunit_40.test('quarter setter singular', function (assert) {
            ...
            qunit_40.test('quarter setter plural', function (assert) {
                var m = moment([2014, 4, 11]);
            ...
            qunit_40.test('quarter setter programmatic', function (assert) {
                var m = moment([2014, 4, 11]);
            ...
            qunit_40.test('quarter setter programmatic plural', function (assert) {
                var m = moment([2014, 4, 11]);
            ...
            qunit_40.test('quarter setter programmatic abbr', function (assert) {
                var m = moment([2014, 4, 11]);
            ...
            qunit_40.test('quarter setter only month changes', function (assert) {
            ...
            qunit_40.test('quarter setter bubble to next year', function (assert) {
            ...
            qunit_40.test('quarter diff', function (assert) {
            ...
            qunit_40.test('quarter setter bubble to previous year', function (assert) {
...
System.register("test/moment/relative_time", ["../../../moment", "test/qunit"], function (exports_55, context_55) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_41.module('relative time');
            qunit_41.test('default thresholds fromNow', function (assert) {
                var a = moment();
            ...
            qunit_41.test('default thresholds toNow', function (assert) {
                var a = moment();
                // Seconds to minutes threshold
                a.subtract(44, 'seconds');
            ...
            qunit_41.test('custom thresholds', function (assert) {
                var a;
            ...
            qunit_41.test('custom rounding', function (assert) {
            ...
            qunit_41.test('retrieve rounding settings', function (assert) {
            ...
            qunit_41.test('retrieve threshold settings', function (assert) {
                moment.relativeTimeThreshold('m', 45);
...
System.register("test/moment/start_end_of", ["../../../moment", "test/qunit"], function (exports_56, context_56) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_42.module('start and end of units');
            qunit_42.test('start of year', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('year'), ms = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('years'), ma = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('y');
            ...
            qunit_42.test('end of year', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('year'), ms = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('years'), ma = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('y');
                assert.equal(+m, +ms, 'Plural or singular should work');
                assert.equal(+m, +ma, 'Full or abbreviated should work');
                assert.equal(m.year(), 2011, 'keep the year');
            ...
            qunit_42.test('start of quarter', function (assert) {
                var m = moment(new Date(2011, 4, 2, 3, 4, 5, 6)).startOf('quarter'), ms = moment(new Date(2011, 4, 2, 3, 4, 5, 6)).startOf('quarters'), ma = moment(new Date(2011, 4, 2, 3, 4, 5, 6)).startOf('Q');
                assert.equal(+m, +ms, 'Plural or singular should work');
                assert.equal(+m, +ma, 'Full or abbreviated should work');
                assert.equal(m.year(), 2011, 'keep the year');
            ...
            qunit_42.test('end of quarter', function (assert) {
                var m = moment(new Date(2011, 4, 2, 3, 4, 5, 6)).endOf('quarter'), ms = moment(new Date(2011, 4, 2, 3, 4, 5, 6)).endOf('quarters'), ma = moment(new Date(2011, 4, 2, 3, 4, 5, 6)).endOf('Q');
                assert.equal(+m, +ms, 'Plural or singular should work');
                assert.equal(+m, +ma, 'Full or abbreviated should work');
                assert.equal(m.year(), 2011, 'keep the year');
                assert.equal(m.quarter(), 2, 'keep the quarter');
            ...
            qunit_42.test('start of month', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('month'), ms = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('months'), ma = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('M');
                assert.equal(+m, +ms, 'Plural or singular should work');
                assert.equal(+m, +ma, 'Full or abbreviated should work');
                assert.equal(m.year(), 2011, 'keep the year');
            ...
            qunit_42.test('end of month', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('month'), ms = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('months'), ma = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('M');
                assert.equal(+m, +ms, 'Plural or singular should work');
                assert.equal(+m, +ma, 'Full or abbreviated should work');
                assert.equal(m.year(), 2011, 'keep the year');
                assert.equal(m.month(), 1, 'keep the month');
            ...
            qunit_42.test('start of week', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('week'), ms = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('weeks'), ma = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('w');
                assert.equal(+m, +ms, 'Plural or singular should work');
                assert.equal(+m, +ma, 'Full or abbreviated should work');
                assert.equal(m.year(), 2011, 'keep the year');
            ...
            qunit_42.test('end of week', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('week'), ms = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('weeks'), ma = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('weeks');
                assert.equal(+m, +ms, 'Plural or singular should work');
                assert.equal(+m, +ma, 'Full or abbreviated should work');
                assert.equal(m.year(), 2011, 'keep the year');
                assert.equal(m.month(), 1, 'keep the month');
            ...
            qunit_42.test('start of iso-week', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('isoWeek'), ms = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('isoWeeks'), ma = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('W');
                assert.equal(+m, +ms, 'Plural or singular should work');
                assert.equal(+m, +ma, 'Full or abbreviated should work');
                assert.equal(m.year(), 2011, 'keep the year');
            ...
            qunit_42.test('end of iso-week', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('isoWeek'), ms = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('isoWeeks'), ma = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('W');
                assert.equal(+m, +ms, 'Plural or singular should work');
                assert.equal(+m, +ma, 'Full or abbreviated should work');
                assert.equal(m.year(), 2011, 'keep the year');
                assert.equal(m.month(), 1, 'keep the month');
            ...
            qunit_42.test('start of day', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('day'), ms = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('days'), ma = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('d');
                assert.equal(+m, +ms, 'Plural or singular should work');
                assert.equal(+m, +ma, 'Full or abbreviated should work');
                assert.equal(m.year(), 2011, 'keep the year');
                assert.equal(m.month(), 1, 'keep the month');
            ...
            qunit_42.test('end of day', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('day'), ms = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('days'), ma = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('d');
                assert.equal(+m, +ms, 'Plural or singular should work');
                assert.equal(+m, +ma, 'Full or abbreviated should work');
                assert.equal(m.year(), 2011, 'keep the year');
                assert.equal(m.month(), 1, 'keep the month');
            ...
            qunit_42.test('start of date', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('date'), ms = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('dates');
                assert.equal(+m, +ms, 'Plural or singular should work');
                assert.equal(m.year(), 2011, 'keep the year');
                assert.equal(m.month(), 1, 'keep the month');
                assert.equal(m.date(), 2, 'keep the day');
            ...
            qunit_42.test('end of date', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('date'), ms = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('dates');
                assert.equal(+m, +ms, 'Plural or singular should work');
                assert.equal(m.year(), 2011, 'keep the year');
                assert.equal(m.month(), 1, 'keep the month');
                assert.equal(m.date(), 2, 'keep the day');
            ...
            qunit_42.test('start of hour', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('hour'), ms = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('hours'), ma = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('h');
                assert.equal(+m, +ms, 'Plural or singular should work');
                assert.equal(+m, +ma, 'Full or abbreviated should work');
                assert.equal(m.year(), 2011, 'keep the year');
                assert.equal(m.month(), 1, 'keep the month');
            ...
            qunit_42.test('end of hour', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('hour'), ms = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('hours'), ma = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('h');
                assert.equal(+m, +ms, 'Plural or singular should work');
                assert.equal(+m, +ma, 'Full or abbreviated should work');
                assert.equal(m.year(), 2011, 'keep the year');
                assert.equal(m.month(), 1, 'keep the month');
            ...
            qunit_42.test('start of minute', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('minute'), ms = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('minutes'), ma = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('m');
                assert.equal(+m, +ms, 'Plural or singular should work');
                assert.equal(+m, +ma, 'Full or abbreviated should work');
                assert.equal(m.year(), 2011, 'keep the year');
                assert.equal(m.month(), 1, 'keep the month');
            ...
            qunit_42.test('end of minute', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('minute'), ms = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('minutes'), ma = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('m');
                assert.equal(+m, +ms, 'Plural or singular should work');
                assert.equal(+m, +ma, 'Full or abbreviated should work');
                assert.equal(m.year(), 2011, 'keep the year');
                assert.equal(m.month(), 1, 'keep the month');
            ...
            qunit_42.test('start of second', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('second'), ms = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('seconds'), ma = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).startOf('s');
                assert.equal(+m, +ms, 'Plural or singular should work');
                assert.equal(+m, +ma, 'Full or abbreviated should work');
                assert.equal(m.year(), 2011, 'keep the year');
                assert.equal(m.month(), 1, 'keep the month');
            ...
            qunit_42.test('end of second', function (assert) {
                var m = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('second'), ms = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('seconds'), ma = moment(new Date(2011, 1, 2, 3, 4, 5, 6)).endOf('s');
                assert.equal(+m, +ms, 'Plural or singular should work');
                assert.equal(+m, +ma, 'Full or abbreviated should work');
                assert.equal(m.year(), 2011, 'keep the year');
                assert.equal(m.month(), 1, 'keep the month');
            ...
            qunit_42.test('startOf across DST +1', function (assert) {
                var oldUpdateOffset = moment.updateOffset, 
                // Based on a real story somewhere in America/Los_Angeles
                dstAt = moment('2014-03-09T02:00:00-08:00').parseZone(), m;
                moment.updateOffset = function (mom, keepTime) {
            ...
            qunit_42.test('endOf millisecond and no-arg', function (assert) {
                var m = moment();
...
System.register("test/moment/string_prototype", ["../../../moment", "test/qunit"], function (exports_57, context_57) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_43.module('string prototype');
            qunit_43.test('string prototype overrides call', function (assert) {
...
System.register("test/moment/to_type", ["../../../moment", "test/qunit"], function (exports_58, context_58) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_44.module('to type');
            qunit_44.test('toObject', function (assert) {
                var expected = {
                    years: 2010,
                    months: 3,
                    date: 5,
            ...
            qunit_44.test('toArray', function (assert) {
                var expected = [2014, 11, 26, 11, 46, 58, 17];
                assert.deepEqual(moment(expected).toArray(), expected, 'toArray invalid');
            });
            qunit_44.test('toDate returns a copy of the internal date', function (assert) {
                var m = moment();
                var d = m.toDate();
                m.year(0);
                assert.notEqual(d, m.toDate());
            });
            qunit_44.test('toJSON', function (assert) {
            ...
            qunit_44.test('toJSON works when moment is frozen', function (assert) {
                if (Date.prototype.toISOString) {
                    var expected = new Date().toISOString();
...
System.register("test/moment/utc", ["../../../moment", "test/qunit"], function (exports_59, context_59) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_45.module('utc');
            qunit_45.test('utc and local', function (assert) {
            ...
            qunit_45.test('creating with utc and no arguments', function (assert) {
                var startOfTest = new Date().valueOf(), momentDefaultUtcTime = moment.utc().valueOf(), afterMomentCreationTime = new Date().valueOf();
            ...
            qunit_45.test('creating with utc and a date parameter array', function (assert) {
            ...
            qunit_45.test('creating with utc without timezone', function (assert) {
            ...
            qunit_45.test('cloning with utc offset', function (assert) {
                var m = moment.utc('2012-01-02T08:20:00');
            ...
            qunit_45.test('weekday with utc', function (assert) {
                assert.equal(moment('2013-09-15T00:00:00Z').utc().weekday(), // first minute of the day
...
System.register("test/moment/utc_offset", ["../../../moment", "test/qunit"], function (exports_60, context_60) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_46.module('utc offset');
            qunit_46.test('setter / getter blackbox', function (assert) {
                var m = moment([2010]);
            ...
            qunit_46.test('utcOffset shorthand hours -> minutes', function (assert) {
                var i;
                for (i = -15; i <= 15; ++i) {
                    assert.equal(moment().utcOffset(i).utcOffset(), i * 60, '' + i + ' -> ' + i * 60);
                }
                assert.equal(moment().utcOffset(-16).utcOffset(), -16, '-16 -> -16');
                assert.equal(moment().utcOffset(16).utcOffset(), 16, '16 -> 16');
            });
            qunit_46.test('isLocal, isUtc, isUtcOffset', function (assert) {
            ...
            qunit_46.test('isUTC', function (assert) {
                assert.ok(moment.utc().isUTC(), 'moment.utc() creates objects in utc time');
                assert.ok(moment().utcOffset(0).isUTC(), 'utcOffset(0) is equivalent to utc mode');
                assert.ok(!moment().utcOffset(1).isUTC(), 'utcOffset(1) is NOT equivalent to utc mode');
            });
            qunit_46.test('change hours when changing the utc offset', function (assert) {
            ...
            qunit_46.test('change minutes when changing the utc offset', function (assert) {
            ...
            qunit_46.test('distance from the unix epoch', function (assert) {
                var zoneA = moment(), zoneB = moment(zoneA), zoneC = moment(zoneA), zoneD = moment(zoneA), zoneE = moment(zoneA);
                zoneB.utc();
            ...
            qunit_46.test('update offset after changing any values', function (assert) {
                var oldOffset = moment.updateOffset, m = moment.utc([2000, 6, 1]);
                moment.updateOffset = function (mom, keepTime) {
                    if (mom.__doChange) {
                        if (+mom > 962409600000) {
            ...
            //////////////////
            qunit_46.test('getters and setters', function (assert) {
            ...
            qunit_46.test('getters', function (assert) {
            ...
            qunit_46.test('from', function (assert) {
                var zoneA = moment(), zoneB = moment(zoneA).utcOffset(-720), zoneC = moment(zoneA).utcOffset(-360), zoneD = moment(zoneA).utcOffset(690), other = moment(zoneA).add(35, 'm');
            ...
            qunit_46.test('diff', function (assert) {
                var zoneA = moment(), zoneB = moment(zoneA).utcOffset(-720), zoneC = moment(zoneA).utcOffset(-360), zoneD = moment(zoneA).utcOffset(690), other = moment(zoneA).add(35, 'm');
            ...
            qunit_46.test('unix offset and timestamp', function (assert) {
                var zoneA = moment(), zoneB = moment(zoneA).utcOffset(-720), zoneC = moment(zoneA).utcOffset(-360), zoneD = moment(zoneA).utcOffset(690);
            ...
            qunit_46.test('cloning', function (assert) {
                assert.equal(moment().utcOffset(-120).clone().utcOffset(), -120, 'explicit cloning should retain the offset');
                assert.equal(moment().utcOffset(120).clone().utcOffset(), 120, 'explicit cloning should retain the offset');
                assert.equal(moment(moment().utcOffset(-120)).utcOffset(), -120, 'implicit cloning should retain the offset');
                assert.equal(moment(moment().utcOffset(120)).utcOffset(), 120, 'implicit cloning should retain the offset');
            });
            qunit_46.test('start of / end of', function (assert) {
                var a = moment.utc([2010, 1, 2, 0, 0, 0]).utcOffset(-450);
                assert.equal(a.clone().startOf('day').hour(), 0, 'start of day should work on moments with utc offset');
                assert.equal(a.clone().startOf('day').minute(), 0, 'start of day should work on moments with utc offset');
                assert.equal(a.clone().startOf('hour').minute(), 0, 'start of hour should work on moments with utc offset');
                ...
                assert.equal(a.clone().endOf('hour').minute(), 59, 'end of hour should work on moments with utc offset');
            });
            qunit_46.test('reset offset with moment#utc', function (assert) {
            ...
            qunit_46.test('reset offset with moment#local', function (assert) {
                var a = moment([2012]).utcOffset(-480);
                assert.equal(a.clone().local().hour(), 0, 'calling moment#local should reset the offset');
            });
            qunit_46.test('toDate', function (assert) {
                var zoneA = new Date(), zoneB = moment(zoneA).utcOffset(-720).toDate(), zoneC = moment(zoneA).utcOffset(-360).toDate(), zoneD = moment(zoneA).utcOffset(690).toDate();
            ...
            qunit_46.test('same / before / after', function (assert) {
                var zoneA = moment().utc(), zoneB = moment(zoneA).utcOffset(-120), zoneC = moment(zoneA).utcOffset(120);
            ...
            qunit_46.test('add / subtract over dst', function (assert) {
                var oldOffset = moment.updateOffset, m = moment.utc([2000, 2, 31, 3]);
                moment.updateOffset = function (mom, keepTime) {
            ...
            qunit_46.test('isDST', function (assert) {
            ...
            qunit_46.test('zone names', function (assert) {
            ...
            qunit_46.test('hours alignment with UTC', function (assert) {
            ...
            qunit_46.test('hours alignment with other zone', function (assert) {
            ...
            qunit_46.test('parse zone with a timezone from the format string', function (assert) {
                var m = moment('11-12-2013 -0400 +1100', 'DD-MM-YYYY ZZ #####').parseZone();
                assert.equal(m.utcOffset(), -4 * 60);
            });
            qunit_46.test('parse zone without a timezone included in the format string', function (assert) {
                var m = moment('11-12-2013 -0400 +1100', 'DD-MM-YYYY').parseZone();
                assert.equal(m.utcOffset(), 11 * 60);
            });
            qunit_46.test('timezone format', function (assert) {
...
System.register("test/moment/week_year", ["../../../moment", "test/qunit"], function (exports_61, context_61) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_47.module('week year');
            qunit_47.test('iso week year', function (assert) {
            ...
            qunit_47.test('week year', function (assert) {
                // Some examples taken from https://en.wikipedia.org/wiki/ISO_week
            ...
            qunit_47.test('week year roundtrip', function (assert) {
            ...
            qunit_47.test('week numbers 2012/2013', function (assert) {
                moment.locale('dow: 6, doy: 12', { week: { dow: 6, doy: 12 } });
            ...
            qunit_47.test('weeks numbers dow:1 doy:4', function (assert) {
                moment.locale('dow: 1, doy: 4', { week: { dow: 1, doy: 4 } });
            ...
            qunit_47.test('weeks numbers dow:6 doy:12', function (assert) {
                moment.locale('dow: 6, doy: 12', { week: { dow: 6, doy: 12 } });
            ...
            qunit_47.test('weeks numbers dow:1 doy:7', function (assert) {
                moment.locale('dow: 1, doy: 7', { week: { dow: 1, doy: 7 } });
            ...
            qunit_47.test('weeks numbers dow:0 doy:6', function (assert) {
                moment.locale('dow: 0, doy: 6', { week: { dow: 0, doy: 6 } });
                assert.equal(moment([2012, 0, 1]).week(), 1, 'Jan  1 2012 should be week 1');
            ...
            qunit_47.test('week year overflows', function (assert) {
            ...
            qunit_47.test('weeks overflow', function (assert) {
            ...
            qunit_47.test('weekday overflow', function (assert) {
            ...
            qunit_47.test('week year setter works', function (assert) {
...
System.register("test/moment/weekday", ["../../../moment", "test/qunit"], function (exports_62, context_62) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_48.module('week day');
            qunit_48.test('iso weekday', function (assert) {
                var i;
                for (i = 0; i < 7; ++i) {
            ...
            qunit_48.test('iso weekday setter', function (assert) {
            ...
            qunit_48.test('iso weekday setter with day name', function (assert) {
                moment.locale('en');
                var a = moment([2011, 0, 10]);
            ...
            qunit_48.test('weekday first day of week Sunday (dow 0)', function (assert) {
                moment.locale('dow: 0,doy: 6', { week: { dow: 0, doy: 6 } });
            ...
            qunit_48.test('weekday first day of week Monday (dow 1)', function (assert) {
            ...
            qunit_48.test('weekday first day of week Tuesday (dow 2)', function (assert) {
            ...
            qunit_48.test('weekday first day of week Wednesday (dow 3)', function (assert) {
            ...
            qunit_48.test('weekday first day of week Thursday (dow 4)', function (assert) {
            ...
            qunit_48.test('weekday first day of week Friday (dow 5)', function (assert) {
            ...
            qunit_48.test('weekday first day of week Saturday (dow 6)', function (assert) {
...
System.register("test/moment/weeks", ["../../../moment", "test/qunit"], function (exports_63, context_63) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_49.module('weeks');
            qunit_49.test('day of year', function (assert) {
            ...
            qunit_49.test('day of year setters', function (assert) {
            ...
            qunit_49.test('iso weeks year starting sunday', function (assert) {
            ...
            qunit_49.test('iso weeks year starting monday', function (assert) {
            ...
            qunit_49.test('iso weeks year starting tuesday', function (assert) {
            ...
            qunit_49.test('iso weeks year starting wednesday', function (assert) {
            ...
            qunit_49.test('iso weeks year starting thursday', function (assert) {
            ...
            qunit_49.test('iso weeks year starting friday', function (assert) {
            ...
            qunit_49.test('iso weeks year starting saturday', function (assert) {
            ...
            qunit_49.test('iso weeks year starting sunday formatted', function (assert) {
            ...
            qunit_49.test('weeks plural year starting sunday', function (assert) {
            ...
            qunit_49.test('iso weeks plural year starting sunday', function (assert) {
            ...
            qunit_49.test('weeks setter', function (assert) {
            ...
            qunit_49.test('iso weeks setter', function (assert) {
            ...
            qunit_49.test('iso weeks setter day of year', function (assert) {
            ...
            qunit_49.test('years with iso week 53', function (assert) {
            ...
            qunit_49.test('count years with iso week 53', function (assert) {
...
System.register("test/moment/weeks_in_year", ["../../../moment", "test/qunit"], function (exports_64, context_64) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_50.module('weeks in year');
            qunit_50.test('isoWeeksInYear', function (assert) {
            ...
            qunit_50.test('weeksInYear doy/dow = 1/4', function (assert) {
            ...
            qunit_50.test('weeksInYear doy/dow = 6/12', function (assert) {
            ...
            qunit_50.test('weeksInYear doy/dow = 1/7', function (assert) {
            ...
            qunit_50.test('weeksInYear doy/dow = 0/6', function (assert) {
...
System.register("test/helpers/dst", ["../../moment"], function (exports_65, context_65) {
    "use strict";
    var __moduleName = context_65 && context_65.id;
    function isNearSpringDST() {
        return moment_50["default"]().subtract(1, 'day').utcOffset() !== moment_50["default"]().add(1, 'day').utcOffset();
    }
    exports_65("isNearSpringDST", isNearSpringDST);
    var moment_50;
    return {
        setters: [
            function (moment_50_1) {
                moment_50 = moment_50_1;
            }
        ],
        execute: function () {
        }
...
System.register("test/moment/zone_switching", ["../../../moment", "test/qunit", "test/helpers/dst"], function (exports_66, context_66) {
    "use strict";
    var __moduleName = context_66 && context_66.id;
    var moment, qunit_51, dst_1;
    return {
        setters: [
            function (moment_51) {
                moment = moment_51;
        ...
        execute: function () {
            qunit_51.module('zone switching');
            qunit_51.test('local to utc, keepLocalTime = true', function (assert) {
                var m = moment(), fmt = 'YYYY-DD-MM HH:mm:ss';
                assert.equal(m.clone().utc(true).format(fmt), m.format(fmt), 'local to utc failed to keep local time');
            });
            qunit_51.test('local to utc, keepLocalTime = false', function (assert) {
                var m = moment();
            ...
            qunit_51.test('local to zone, keepLocalTime = true', function (assert) {
                qunit_51.test.expectedDeprecations('moment().zone');
                var m = moment(), fmt = 'YYYY-DD-MM HH:mm:ss', z;
                // Apparently there is -12:00 and +14:00
                // https://en.wikipedia.org/wiki/UTC+14:00
                // https://en.wikipedia.org/wiki/UTC-12:00
                for (z = -12; z <= 14; ++z) {
                    assert.equal(m.clone().zone(z * 60, true).format(fmt), m.format(fmt), 'local to zone(' + z + ':00) failed to keep local time');
                }
            });
            qunit_51.test('local to zone, keepLocalTime = false', function (assert) {
                qunit_51.test.expectedDeprecations('moment().zone');
                var m = moment(), z;
                // Apparently there is -12:00 and +14:00
                // https://en.wikipedia.org/wiki/UTC+14:00
                // https://en.wikipedia.org/wiki/UTC-12:00
                for (z = -12; z <= 14; ++z) {
                    assert.equal(m.clone().zone(z * 60).valueOf(), m.valueOf(), 'local to zone(' + z + ':00) failed to keep utc time (implicit)');
                    assert.equal(m.clone().zone(z * 60, false).valueOf(), m.valueOf(), 'local to zone(' + z + ':00) failed to keep utc time (explicit)');
                }
            });
            qunit_51.test('utc to local, keepLocalTime = true', function (assert) {
                // Don't test near the spring DST transition
                if (dst_1.isNearSpringDST()) {
                    qunit_51.expect(0);
                    return;
                }
                var um = moment.utc(), fmt = 'YYYY-DD-MM HH:mm:ss';
                assert.equal(um.clone().local(true).format(fmt), um.format(fmt), 'utc to local failed to keep local time');
            });
            qunit_51.test('utc to local, keepLocalTime = false', function (assert) {
                var um = moment.utc();
            ...
            qunit_51.test('zone to local, keepLocalTime = true', function (assert) {
                // Don't test near the spring DST transition
                if (dst_1.isNearSpringDST()) {
                    qunit_51.expect(0);
                    return;
                ...
                for (z = -12; z <= 14; ++z) {
                    m.zone(z * 60);
                    assert.equal(m.clone().local(true).format(fmt), m.format(fmt), 'zone(' + z + ':00) to local failed to keep local time');
                }
            });
            qunit_51.test('zone to local, keepLocalTime = false', function (assert) {
                qunit_51.test.expectedDeprecations('moment().zone');
                var m = moment(), z;
                // Apparently there is -12:00 and +14:00
                // https://en.wikipedia.org/wiki/UTC+14:00
                ...
                for (z = -12; z <= 14; ++z) {
                    m.zone(z * 60);
                    assert.equal(m.clone().local(false).valueOf(), m.valueOf(), 'zone(' + z + ':00) to local failed to keep utc time (explicit)');
                    assert.equal(m.clone().local().valueOf(), m.valueOf(), 'zone(' + z + ':00) to local failed to keep utc time (implicit)');
                }
            });
        }
    };
});
System.register("test/moment/zones", ["../../../moment", "test/qunit"], function (exports_67, context_67) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            qunit_52.module('zones', {
                'setup': function () {
                    qunit_52.test.expectedDeprecations('moment().zone');
                }
            });
            qunit_52.test('set zone', function (assert) {
                var zone = moment();
                zone.zone(0);
            ...
            qunit_52.test('set zone shorthand', function (assert) {
                var zone = moment();
                zone.zone(1);
            ...
            qunit_52.test('set zone with string', function (assert) {
                var zone = moment();
                zone.zone('+00:00');
            ...
            qunit_52.test('change hours when changing the zone', function (assert) {
            ...
            qunit_52.test('change minutes when changing the zone', function (assert) {
            ...
            qunit_52.test('distance from the unix epoch', function (assert) {
                var zoneA = moment(), zoneB = moment(zoneA), zoneC = moment(zoneA), zoneD = moment(zoneA), zoneE = moment(zoneA);
                zoneB.utc();
                assert.equal(+zoneA, +zoneB, 'moment should equal moment.utc');
                zoneC.zone(-60);
            ...
            qunit_52.test('update offset after changing any values', function (assert) {
                var oldOffset = moment.updateOffset, m = moment.utc([2000, 6, 1]);
                moment.updateOffset = function (mom, keepTime) {
                    if (mom.__doChange) {
                        if (+mom > 962409600000) {
            ...
            qunit_52.test('getters and setters', function (assert) {
                var a = moment([2011, 5, 20]);
            ...
            qunit_52.test('getters', function (assert) {
                var a = moment.utc([2012, 0, 1, 0, 0, 0]);
            ...
            qunit_52.test('from', function (assert) {
                var zoneA = moment(), zoneB = moment(zoneA).zone(720), zoneC = moment(zoneA).zone(360), zoneD = moment(zoneA).zone(-690), other = moment(zoneA).add(35, 'm');
                assert.equal(zoneA.from(other), zoneB.from(other), 'moment#from should be the same in all zones');
                assert.equal(zoneA.from(other), zoneC.from(other), 'moment#from should be the same in all zones');
                assert.equal(zoneA.from(other), zoneD.from(other), 'moment#from should be the same in all zones');
            });
            qunit_52.test('diff', function (assert) {
                var zoneA = moment(), zoneB = moment(zoneA).zone(720), zoneC = moment(zoneA).zone(360), zoneD = moment(zoneA).zone(-690), other = moment(zoneA).add(35, 'm');
                assert.equal(zoneA.diff(other), zoneB.diff(other), 'moment#diff should be the same in all zones');
                assert.equal(zoneA.diff(other), zoneC.diff(other), 'moment#diff should be the same in all zones');
                assert.equal(zoneA.diff(other), zoneD.diff(other), 'moment#diff should be the same in all zones');
            ...
            qunit_52.test('unix offset and timestamp', function (assert) {
                var zoneA = moment(), zoneB = moment(zoneA).zone(720), zoneC = moment(zoneA).zone(360), zoneD = moment(zoneA).zone(-690);
                assert.equal(zoneA.unix(), zoneB.unix(), 'moment#unix should be the same in all zones');
                assert.equal(zoneA.unix(), zoneC.unix(), 'moment#unix should be the same in all zones');
                assert.equal(zoneA.unix(), zoneD.unix(), 'moment#unix should be the same in all zones');
                assert.equal(+zoneA, +zoneB, 'moment#valueOf should be the same in all zones');
            ...
            qunit_52.test('cloning', function (assert) {
            ...
            qunit_52.test('start of / end of', function (assert) {
            ...
            qunit_52.test('reset zone with moment#utc', function (assert) {
                var a = moment.utc([2012]).zone(480);
                assert.equal(a.clone().hour(), 16, 'different zone should have different hour');
                assert.equal(a.clone().utc().hour(), 0, 'calling moment#utc should reset the offset');
            });
            qunit_52.test('reset zone with moment#local', function (assert) {
                var a = moment([2012]).zone(480);
                assert.equal(a.clone().local().hour(), 0, 'calling moment#local should reset the offset');
            });
            qunit_52.test('toDate', function (assert) {
                var zoneA = new Date(), zoneB = moment(zoneA).zone(720).toDate(), zoneC = moment(zoneA).zone(360).toDate(), zoneD = moment(zoneA).zone(-690).toDate();
                assert.equal(+zoneA, +zoneB, 'moment#toDate should output a date with the right unix timestamp');
                assert.equal(+zoneA, +zoneC, 'moment#toDate should output a date with the right unix timestamp');
                assert.equal(+zoneA, +zoneD, 'moment#toDate should output a date with the right unix timestamp');
            });
            qunit_52.test('same / before / after', function (assert) {
                var zoneA = moment().utc(), zoneB = moment(zoneA).zone(120), zoneC = moment(zoneA).zone(-120);
                assert.ok(zoneA.isSame(zoneB), 'two moments with different offsets should be the same');
                assert.ok(zoneA.isSame(zoneC), 'two moments with different offsets should be the same');
                assert.ok(zoneA.isSame(zoneB, 'hour'), 'two moments with different offsets should be the same hour');
                assert.ok(zoneA.isSame(zoneC, 'hour'), 'two moments with different offsets should be the same hour');
            ...
            qunit_52.test('add / subtract over dst', function (assert) {
                var oldOffset = moment.updateOffset, m = moment.utc([2000, 2, 31, 3]);
                moment.updateOffset = function (mom, keepTime) {
                    if (mom.clone().utc().month() > 2) {
                        mom.zone(-60, keepTime);
            ...
            qunit_52.test('isDST', function (assert) {
                var oldOffset = moment.updateOffset;
                moment.updateOffset = function (mom, keepTime) {
                    if (mom.month() > 2 && mom.month() < 9) {
                        mom.zone(-60, keepTime);
            ...
            qunit_52.test('zone names', function (assert) {
                qunit_52.test.expectedDeprecations();
                assert.equal(moment().zoneAbbr(), '', 'Local zone abbr should be empty');
                assert.equal(moment().format('z'), '', 'Local zone formatted abbr should be empty');
                assert.equal(moment().zoneName(), '', 'Local zone name should be empty');
                assert.equal(moment().format('zz'), '', 'Local zone formatted name should be empty');
            ...
            qunit_52.test('hours alignment with UTC', function (assert) {
            ...
            qunit_52.test('hours alignment with other zone', function (assert) {
            ...
            qunit_52.test('parse zone', function (assert) {
                var m = moment('2013-01-01T00:00:00-13:00').parseZone();
                assert.equal(m.zone(), 13 * 60);
                assert.equal(m.hours(), 0);
            });
            qunit_52.test('parse zone static', function (assert) {
                var m = moment.parseZone('2013-01-01T00:00:00-13:00');
                assert.equal(m.zone(), 13 * 60);
                assert.equal(m.hours(), 0);
            });
            qunit_52.test('parse zone with more arguments', function (assert) {
                qunit_52.test.expectedDeprecations();
                var m;
                m = moment.parseZone('2013 01 01 05 -13:00', 'YYYY MM DD HH ZZ');
                assert.equal(m.format(), '2013-01-01T05:00:00-13:00', 'accept input and format');
            ...
            qunit_52.test('parse zone with a timezone from the format string', function (assert) {
                var m = moment('11-12-2013 -0400 +1100', 'DD-MM-YYYY ZZ #####').parseZone();
                assert.equal(m.zone(), 4 * 60);
            });
            qunit_52.test('parse zone without a timezone included in the format string', function (assert) {
                var m = moment('11-12-2013 -0400 +1100', 'DD-MM-YYYY').parseZone();
                assert.equal(m.zone(), -11 * 60);
            });
            qunit_52.test('timezone format', function (assert) {
            ...
            qunit_52.test('parse zone without a timezone', function (assert) {
                qunit_52.test.expectedDeprecations();
                ...
                assert.equal(m1.format('M D YYYY HH:mm:ss ZZ'), '2 1 2016 00:00:00 +0000', 'Not providing a timezone should keep the time and change the zone to 0');
                assert.equal(m2.format('M D YYYY HH:mm:ss ZZ'), '2 1 2016 00:00:00 +0000', 'Not providing a timezone should keep the time and change the zone to 0');
                assert.equal(m3.format('M D YYYY HH:mm:ss ZZ'), '2 1 2016 00:00:00 +0000', 'Not providing a timezone should keep the time and change the zone to 0');
                assert.equal(m4.format('M D YYYY HH:mm:ss ZZ'), '2 1 2016 00:00:00 +0000', 'Not providing a timezone should keep the time and change the zone to 0');
            });
            qunit_52.test('parse zone with a minutes unit abs less than 16 should retain minutes', function (assert) {
